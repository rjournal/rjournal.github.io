---
title: 'vivid: An R package for Variable Importance and Variable Interactions Displays
...
preamble: \usepackage{subfig} \usepackage{tabu} \usepackage{longtable} \usepackage{colortbl}
  \usepackage{xcolor}
draft: no
author:
- name: Alan Inglis
