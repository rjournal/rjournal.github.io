...
author:
- Shangkun Wang, Weijun Xie and V. Roshan Joseph
bibliography:
- shangkun-wang.bib
...
<figure id="fig:maximin_7points">
<img src="fig/Maximin_seven_points.png" style="width:100.0%"
alt="graphic without alt text" />
<figcaption>Figure 1: </figcaption>
</figure>
<figure id="fig:maximin_record">
<img src="fig/Maximin_compare_record.png" style="width:100.0%"
alt="graphic without alt text" />
<figcaption>Figure 2: </figcaption>
</figure>
<figcaption>Figure 3: (a) Seven-point maximin design in two dimension
generated by <a
...
and Gramacy 2024) in
Figure [6](#fig:maximin_compare){reference-type="ref"
...
![Figure 4: Trajectory of the criterion value with respect to the number
...
represents the `SLHD`
package.](fig/complexity_comparison.png){#fig:complexity width="80%"}
...
<img src="fig/maximin_discrete.png" style="width:40.0%" />
<figcaption>Figure 5: A maximin design of size 20 generated by
...
![Figure 6: Comparison of the reciprocal distance criterion of designs
...
Figure [7](#fig:maxpro_traj){reference-type="ref"
...
![Figure 7: The trajectory of the MaxPro criterion during
optimization.](fig/MaxPro_traj.png){#fig:maxpro_traj width="65%"}
...
illustrated in Figure [8](#fig:maxpro_compare){reference-type="ref"
...
![Figure 8: Comparison of the maximum projection criteria (smaller the
...
quantiles.](fig/MaxPro_compare.png){#fig:maxpro_compare width="99%"}
...
![Figure 9: Comparison of the wrap-around discrepancy (smaller the
better) of designs generated by
...
quantiles.](fig/uniform_compare.png){#fig:uniform_compare width="99%"}
...
Figure [10](#fig:cluster_compare){reference-type="ref"
...
Figure [11](#fig:cluster_time){reference-type="ref"
...
<img src="fig/clustering_time.png" style="width:100.0%"
alt="graphic without alt text" />
<figcaption>Figure 11: </figcaption>
</figure>
<figcaption>Figure 12: (a) Comparison of the clustering error of designs
generated by <a
...
Figure [13](#fig:surrogate_design){reference-type="ref"
...
![Figure 13: Maximum projection LHD generated by
`SFDesign`](fig/surrogate_design.png){#fig:surrogate_design width="60%"}
...
![Figure 14: Left: Boxplots of maximum projection criterion of maximum
...
experiments.](fig/case_surrogate.png){#fig:case_surrogate width="68%"}
...
ranges. Figure [15](#fig:case_uq){reference-type="ref"
...
![Figure 15: Boxplots of wrap-around discrepancy of designs generated by
...
experiments.](fig/case_uq.png){#fig:case_uq width="99%"}
