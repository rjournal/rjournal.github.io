...
# Please edit salmeron-etal.Rmd to modify this file
...
## ----Results simulation 1, cache = TRUE, echo = TRUE--------------------------
  RdetR(X_S1)
  CNs(X_S1)
  VIF(X_S1)
  CVs(X_S1)
...
## ----Simulation1MCIndex, cache = TRUE, include=FALSE--------------------------
  ite = 100
...
## ----Simulation1randomlatex, eval=knitr::is_latex_output(), tab.cap="MC index for Simulation 1."----
  ...
  knitr::kable(Simulation1_random, format="latex", col.names=c("X2","X3","X4"), caption="MC index for Simulation 1. Three random iterations, the average value of the 100 times and the standard deviation for euclidian and studentise transformations.", align ="cccc")
...
#>   Simulation1_random = t(Simulation1_random)
#>   rownames(Simulation1_random)=c("Euclidean - Random 1", "Euclidean - Random 2", "Euclidean - Random 3", "Euclidean - Average", "Euclidean - Standard Deviation", "Studentise - Random 1", "Studentise - Random 2", "Studentise - Random 3", "Studentise - Average", "Studentise - Standard Deviation")
#>   knitr::kable(Simulation1_random, format="html", col.names=c("X2","X3","X4"), caption="MC index for Simulation 1. Three random iterations, the average value of the 100 times and the standard deviation for euclidian and studentise transformations.", align ="cccc")


## ----simulation 2, cache = TRUE-----------------------------------------------
set.seed(2021)
n = 100
X2_S2 = rnorm(n, 10, 10)
X3_S2 = rnorm(n, 10, 10)
...
## ----Results simulation 2, cache = TRUE, echo = TRUE--------------------------
RdetR(X_S2)
CNs(X_S2)
VIF(X_S2)
CVs(X_S2)
...
## ----Simulation 2 MC Index, cache = TRUE, include=FALSE-----------------------
ite = 100
...
knitr::kable(Simulation2_random, format="latex", col.names =c("X2","X3","X4"),  caption="MC index for Simulation 2. Three random iterations, the average value of the 100 times and the standard deviation for euclidian and studentise transformations.", align ="ccccc")
...
#> Simulation2_random = t(Simulation2_random)
#> rownames(Simulation2_random)=c("Euclidean - Random 1", "Euclidean - Random 2", "Euclidean - Random 3", "Euclidean - Average", "Euclidean - Standard Deviation", "Studentise - Random 1", "Studentise - Random 2", "Studentise - Random 3", "Studentise - Average", "Studentise - Standard Deviation")
#> knitr::kable(Simulation2_random, format="html", col.names =c("X2","X3","X4"),  caption="MC index for Simulation 2. Three random iterations, the average value of the 100 times and the standard deviation for euclidian and studentise transformations.", align ="ccccc")


## ----simulation 3, cache = TRUE-----------------------------------------------
set.seed(2021)
n = 100
X2_S3 = rnorm(n, 10, 10)
X3_S3 = rnorm(n, 10, 10)
...
## ----Results simulation 3, cache = TRUE, echo = TRUE--------------------------
RdetR(X_S3)
CNs(X_S3)
VIF(X_S3)
CVs(X_S3)
...
## ----Simulation 3 MC Index, cache = TRUE, include=FALSE-----------------------
ite = 100
...
#> knitr::kable(Simulation3_random, format="html", col.names =c("X2","X3","X4"),  caption="MC index for Simulation 3. Three random iterations, the average value of the 100 times and the standard deviation for euclidian and studentise transformations.", align ="cccc")
...
Simulation3_random = t(Simulation3_random)
rownames(Simulation3_random)=c("Euclidean - Random 1", "Euclidean - Random 2", "Euclidean - Random 3", "Euclidean - Average", "Euclidean - Standard Deviation", "Studentise - Random 1", "Studentise - Random 2", "Studentise - Random 3", "Studentise - Average", "Studentise - Standard Deviation")
knitr::kable(Simulation3_random, format="latex", col.names =c("X2","X3","X4"),  caption="MC index for Simulation 3. Three random iterations, the average value of the 100 times and the standard deviation for euclidian and studentise transformations.", align ="cccc")


## ----Example1Datalatex, eval = knitr::is_latex_output(), tab.cap="Data set for example 1"----
table01=data.frame(
...
knitr::kable(table01, format="latex", caption="Data set for example . @Salmeron2020a", align ="cccc")


## ----Example1Datahtml, eval=knitr::is_html_output(), tab.cap="Data set for example 1"----
#> table01=data.frame(
#>   Euribor=c(3.63,3.90,3.45,3.01,2.54,2.23,2.20,2.36,2.14,2.29,2.35,2.32,2.32,2.19,2.20,2.63,2.95,3.31,3.62,3.60,4.09,4.38,4.65,4.68,4.48,5.05,5.37,4.34,2.22,1.67,1.34,1.24,1.22,1.25,1.40,1.52,1.74,2.13,2.11,2.06,1.67,1.28,0.90,0.60,0.57,0.51,0.54),
#>   HIPC=c(92.92,  93.85,  93.93,  94.41,  95.08,  95.73,  95.90,  96.40,  96.77,  97.97,  98.06,  98.67,
#>          98.76,  99.96, 100.30, 100.97, 101.07, 102.44, 102.52, 102.79, 102.97, 104.38, 104.45, 105.77,
...
## ----Results Example1, cache = TRUE, echo = TRUE------------------------------
RdetR(data1)
CNs(data1)
VIF(data1)
CVs(data1)
...
## ----Example1-static, eval=knitr::is_latex_output(), out.width="50%", fig.show="hold", fig.cap="Representation  of example 1 using the R tourr package. No linear relationship is observed between the explanatory variables. See html version for an interactive 2-D tour."----
...
## ----Example1-interactive, eval=knitr::is_html_output(), fig.cap="An interactive 2-D tour for example 1 by using the R tourr package. No linear relationship is observed between the explanatory variables."----
#> knitr::include_graphics("animation1.gif")


## ----Example1_MCindex euclidian, tab.cap="MC index results for example 1 with Euclidian transformation"----
set.seed(2022)
...
## ----Results Example2, cache = TRUE, echo = TRUE------------------------------
RdetR(data2)
CNs(data2)
VIF(data2)
CVs(data2)
...
## ----Example2-static, eval=knitr::is_latex_output(), out.width="50%", fig.show="hold", fig.cap="Representation  of example 2 using the R tourr package. A certain linear relationship bewteen independent variables is observed. See html version for an interactive 2-D tour."----
...
## ----Example2-interactive, eval=knitr::is_html_output(), fig.cap="An interactive 2-D tour for example 2 by using the R tourr package. A certain linear relationship bewteen independent variables is observed."----
#> knitr::include_graphics("animation2.gif")


## ----Example2_MCindex euclidian, tab.cap="MC index results for example 2 with Euclidian transformation"----
set.seed(2022)
...
## ----FigureS1,  fig.cap="Representation of the VIFs and CVs of explanatory variables in Simulation 1.  A troubling degree of essential multicollinearity due to variables 3 and 4 is detected by considering thresholds of 0.1002506 (CV) and 10  (VIF) highlighted with red lines."----
vifs = VIF(X_S1)
cvs = CVs(X_S1)
...
## ----FigureS2, fig.cap="Representation of the VIFs and CVs of explanatory variables in Simulation 2.  A troubling degree of non-essential multicollinearity due to variable 4 is detected by considering thresholds of 0.1002506 (CV) and 10  (VIF) highlighted with red lines."----
vifs = VIF(X_S2)
cvs = CVs(X_S2)
...
## ----FigureS3, fig.cap="Representation of the VIFs and CVs of explanatory variables in Simulation 3 . The degree of  multicollinearity is not troubling by considering thresholds of 0.1002506 (CV) and 10 (VIF) highlighted with red lines."----
vifs = VIF(X_S3)
cvs = CVs(X_S3)
plot(cvs, vifs, col="blue", lwd=3, xlim=c(0, max(cvs)), ylim=c(0, max(vifs)+10), xlab="Coefficient of Variation", ylab="Variance Inflation Factor")
abline(h=10, col="red", lwd=2, lty=2)
...
## ----FigureExample1, fig.cap="Representation of the VIFs and CVs of the variables of example 1. A troubling degree of non-essential multicollinearity generated by variable 2 (HIPC) by considering thresholds of 0.1002506 (CV) and 10  (VIF) highlighted with red lines."----
vifs = VIF(data1)
cvs = CVs(data1)
plot(cvs, vifs, col="blue", lwd=3, xlim=c(0, max(cvs)), ylim=c(0, max(vifs)+10), xlab="Coefficient of Variation", ylab="Variance Inflation Factor")
abline(h=10, col="red", lwd=2, lty=2)
...
## ----FigureExample2, fig.cap="Representation of the VIFs and CVs of the variables of example 2. A troubling degree of Essential multicollinearity generated by variables 3 and 4 (limit and rating) by considering thresholds of 0.1002506 (CV) and 10 (VIF) highlighted with red lines."----
vifs = VIF(data2)
cvs = CVs(data2)
plot(cvs, vifs, col="blue", lwd=3, xlim=c(0, max(cvs)), ylim=c(0, max(vifs)+10), xlab="Coefficient of Variation", ylab="Variance Inflation Factor")
abline(h=10, col="red", lwd=2, lty=2)
