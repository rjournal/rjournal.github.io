...
This can be done via \CRANpkg{mlr3tuning} [@mlr3tuning] which contains functionality to tune models for multiple metrics, described in more detail in the [mlr3book](https://mlr3book.mlr-org.com/optimization.html#mult-measures-tuning) [@mlr3book].
...
* \CRANpkg{mlr3tuning} and \CRANpkg{bbotk} [@bbotk] for its extensive tuning capabilities.
