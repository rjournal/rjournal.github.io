...
This check list has been derived from the [Instructions for Authors](https://journal.r-project.org/share/author-guide.pdf) and [proof reading checklist](https://journal.r-project.org/share/proofreading-checklist.pdf). It is designed for using after the article has been accepted before the issue is built.

**NOTE: A check means that this is NOT done, and needs fixing by the authors**

This check list can be sent back to the author, for final paper polishing before publication.

# Proofing check (Assistant)

- [ ] style file has NOT been used to typeset code, files and definitions

- [X] figures and/or tables exceed margins, or need better formatting
...
- [X] \\section* and \\subsection* commands have been used, instead of \\section or \\subsection
...
- [X] article DOES NOT use \\maketitle followed immediately by \\abstract 
...
- [X] IS NOT minimal BibTeX file without unnecessary fields such as abstracts
...
- [X] NOT only strictly essential LATEX\\usepackage commands included in ‘RJwrapper.tex’
