...
#' 
#' As the computation time of some spatial scan statistics can be a bit long in this file,
#' we also provide a file "frevent_restricted_time.R" which is a version with fewer permutations 
#' for the p-value estimation, that is 99 instead of the default value which is 999 (version of this file). 
