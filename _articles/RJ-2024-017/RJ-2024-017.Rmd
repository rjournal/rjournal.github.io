---
title: 'BCClong: An R Package for Bayesian Consensus Clustering for Multiple Longitudinal
  Features'
abstract: |
...
author:
- name: Zhiwen Tan
  affiliation: Department of Public Health Sciences
  address: |
    Queen's University
- name: Chang Shen
