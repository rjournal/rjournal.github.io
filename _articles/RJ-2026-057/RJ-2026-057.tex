...
\begin{figure}
\includegraphics[width=1\linewidth]{RJ-2026-057_files/figure-latex/spatial-plot-1} \caption{A spatial plot of data.}\label{fig:spatial-plot}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{RJ-2026-057_files/figure-latex/default-posterior-plots-1} \caption{Posterior density plots at selected sites using the default range of zk.}\label{fig:default-posterior-plots}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{RJ-2026-057_files/figure-latex/updated-posterior-plots-1} \caption{Posterior density plots at selected sites using the updated range of zk.}\label{fig:updated-posterior-plots}
\end{figure}
...
#> 230  40.7908 -111.4078 -0.1425   0.0965
...
\begin{figure}
\includegraphics[width=0.9\linewidth]{RJ-2026-057_files/figure-latex/residual-plot-1} \caption{Residual diagnostics for hard data.}\label{fig:residual-plot}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{RJ-2026-057_files/figure-latex/sim-plot-1} \caption{A spatial plot of the simulated data.}\label{fig:sim-plot}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{RJ-2026-057_files/figure-latex/variogram-plot-1} \caption{Empirical (points) and theoretical (line) variograms for the data.}\label{fig:variogram-plot}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{RJ-2026-057_files/figure-latex/sim-posterior-plots-1} \caption{Posterior density plots at selected locations using the default range of zk.}\label{fig:sim-posterior-plots}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{RJ-2026-057_files/figure-latex/sim-pred-plots-1} \caption{Spatial plots of the posterior mean and variance.}\label{fig:sim-pred-plots}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.9\linewidth]{RJ-2026-057_files/figure-latex/sim-residual-plot-1} \caption{Residual diagnostics for hard data.}\label{fig:sim-residual-plot}
\end{figure}
