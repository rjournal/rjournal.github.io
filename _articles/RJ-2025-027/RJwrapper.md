...
- by Wolfgang Rolke
bibliography:
- RgofR2sampleRolke.bib
title: "Rgof and R2sample: Testing and Benchmarking for the Univariate
  Goodness-of-Fit and Two-Sample Problems"
---
...
dependence cases.](figures/fig1.png){#fig:fig1 width="4in"}
...
data.](figures/fig2.png){#fig:fig2 width="4in"}
...
data.](figures/fig3.png){#fig:fig3 width="4in"}
...
distribution.](figures/fig4.png){#fig:fig4 width="4in"}
...
distributions.](figures/fig5.png){#fig:fig5 width="4in"}
