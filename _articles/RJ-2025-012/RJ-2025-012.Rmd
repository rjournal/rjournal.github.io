---
title: 'boinet: An R Package for Bayesian Optimal Interval Design for Dose Finding
  Based on Both Efficacy and Toxicity Outcomes'
abstract: |
  ...
  combination (TITE-gBOIN-ET). The R package boinet implements the
  BOIN-ET design family. The package supports
...
[@xiaomeng:2025] and
[**escalation**](https://CRAN.R-project.org/package=escalation)
...
The [**boinet**](https://CRAN.R-project.org/package=boinet)
[@yamaguchi:2025] package implements the BOIN-ET design
...
![(#fig:1) Dose-toxicity and dose-efficacy relationship considered in
...
Some of the key arguments are detailed in Tables \@ref(tab:T1), \@ref(tab:T2), \@ref(tab:T3), and \@ref(tab:T4), in the Appendix. Here, `toxprob` and `effprob` are vectors of true toxicity and
...
Some of the key arguments are detailed in Tables \@ref(tab:T1), \@ref(tab:T2), \@ref(tab:T3), and \@ref(tab:T4), in the Appendix. It should be noted that the TITE-BOIN-ET design has a
...
Some of the key arguments are detailed in Tables \@ref(tab:T1), \@ref(tab:T2), \@ref(tab:T3), and \@ref(tab:T4), in the Appendix. Here, `toxprob` and `effprob` are matrices of true
...
Some of the key arguments are detailed in Tables \@ref(tab:T1), \@ref(tab:T2), \@ref(tab:T3), and \@ref(tab:T4), in the Appendix. It should be noted that the TITE-gBOIN-ET design has a
suspension rule which holds off the decision on dose allocation (i.e.,
patient enrollment to the next cohort) until adequate information is
collected, where the dose allocation is allowed only if more than 50% of
patients have finished the assessment at the current dose level.
