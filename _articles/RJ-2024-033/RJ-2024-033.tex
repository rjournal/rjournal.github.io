...
\centering
\includegraphics{IRTest_files/figure-latex/LDE-validation-latex-1.pdf}
...
Figure \protect\hyperlink{fig:LDE-validation-latex}{1} illustrates the estimated latent
...
Among these two models, \texttt{model\_normal} assumes normality, whereas
...
\centering
\includegraphics{IRTest_files/figure-latex/estimated-density-latex-1.pdf}
\caption{The true, normal, and estimated latent
distributions}\label{fig:estimated-density-latex}
}
\end{figure}

Figure \protect\hyperlink{fig:estimated-density-latex}{2} is drawn with a slight addition
...
\centering
\includegraphics{IRTest_files/figure-latex/realplot-latex-1.pdf}
...
\centering
\includegraphics{IRTest_files/figure-latex/plotitem-latex-1.pdf}
...
\centering
\includegraphics{IRTest_files/figure-latex/inform-latex-1.pdf}
