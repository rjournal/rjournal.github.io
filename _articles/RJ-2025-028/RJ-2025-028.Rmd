...
(ref:rahlfplainFigCap) The main plot from Figure 6 without the two columns of text annotation.  This plot is drawn using functions from the `graphics` package.
...
(ref:schneiderplainFigCap) The main plot from Figure 8 without the annotated mathematical expression. This plot is produced using the packages ggplot2 and ggtext.
...
(ref:anzjsplainFigCap) The main plot from Figure 10 without the numbered list items as annotations.  This plot is produced using the ggplot2 package.
...
(ref:latticeplainFigCap) The main plot from Figure 12 without the title and annotations in each panel.  This plot is produced using the lattice package.
