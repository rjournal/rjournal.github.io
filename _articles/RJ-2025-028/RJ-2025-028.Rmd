...
step is performed by a *DVI driver*, for example `dvipdf` for PDF output
...
ggGeom <- ggplot(samples) +
    ...
    theme_minimal() +
    theme(axis.text.x.bottom=element_latex(size=16, packages="tikz", 
