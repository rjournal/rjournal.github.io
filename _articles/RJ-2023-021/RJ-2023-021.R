...
# Please edit RJ-2023-021.Rmd to modify this file
...
## ----fullhexmap, fig.cap = "A hexagon tile map of Australia at SA2 level showing the reference undistorted maps (grey) and carotgrams (blue). The colours communicate the value of the estimated SIR of thyroid cancer for females, ranging from much lower than average (blue) to much higher than average (red)"----
