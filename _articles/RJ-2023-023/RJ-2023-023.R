...
# Please edit RJ-2023-023.Rmd to modify this file
...
## ----read-TLE, echo = TRUE, eval = TRUE, results = "hide"---------------------
...
## ----read-RINEX, echo = TRUE, eval = TRUE, results = "hide"-------------------
...
## ----sgp4-args-table-definition, eval = TRUE, include = FALSE-----------------
...
## ----sgp4-args-table, eval = TRUE, layout = "l-body-outset", echo=FALSE-------
...
## ----sgp4-ISS-definition, echo = TRUE, include=TRUE, eval=TRUE, results='hide', fig.show='hide'----
...
## ----sgp4-ISS-figure-static, echo = FALSE, fig.cap="Trajectory of the International Space Station (ISS) calculated with the SGP4 propagator. The ISS is in a low Earth orbit, around 400 km above Earth's surface.", include=TRUE, eval=knitr::is_latex_output(), fig.align='center', fig.height = 7, out.width="99%"----
knitr::include_graphics("static/ISS_static.png")

## ----sgp4-ISS-figure-interactive, echo = FALSE, fig.cap="Trajectory of the International Space Station (ISS) calculated with the SGP4 propagator. The ISS is in a low Earth orbit, around 400 km above Earth's surface.", include=TRUE, eval=knitr::is_html_output(), fig.align='center', fig.height = 7----
#> combined_animation_ISS


## ----sdp4-Molniya-definition, echo = TRUE, include=TRUE, eval=TRUE, results='hide', fig.show='hide'----
...
## ----sdp4-Molniya-figure-static, echo = FALSE, fig.cap="Trajectory of a Molniya satellite calculated with the SDP4 propagator. The satellite follows a highly elliptical orbit.", include=TRUE, eval=knitr::is_latex_output(), fig.align='center', fig.height = 7, out.width="99%"----
knitr::include_graphics("static/Molniya_static.png")

## ----sdp4-Molniya-figure-interactive, echo = FALSE, fig.cap="Trajectory of a Molniya satellite calculated with the SDP4 propagator. The satellite follows a highly elliptical orbit.", include=TRUE, eval=knitr::is_html_output(), fig.align='center', fig.height = 7----
#> combined_animation_Molniya


## ----hpop-GPS-definition, echo = TRUE, include=TRUE, eval=TRUE, results='hide', fig.show='hide'----
...
## ----hpop-GPS-figure-static, echo = FALSE, fig.cap="Trajectory of a GPS satellite calculated with the high-precision numerical propagator. It follows an almost circular orbit at an altitude of approximately 20200 km, which allows it to cover a larger portion of Earth at any given time.", include=TRUE, eval=knitr::is_latex_output(), fig.align='center', fig.height = 7, out.width="99%"----
knitr::include_graphics("static/GPS_static.png")

## ----hpop-GPS-figure-interactive, echo = FALSE, fig.cap="Trajectory of a GPS satellite calculated with the high-precision numerical propagator. It follows an almost circular orbit at an altitude of approximately 20200 km, which allows it to cover a larger portion of Earth at any given time.", include=TRUE, eval=knitr::is_html_output(), fig.align='center', fig.height = 7----
#> combined_animation_GPS


## ----conversions-table-definition, eval = TRUE, include = FALSE---------------
...
## ----conversions-table-latex, eval = knitr::is_latex_output(), echo=FALSE, layout = "l-body-outset"----
...
## ----conversions-table-html, eval = knitr::is_html_output(), echo=FALSE, layout = "l-body-outset"----
...
## ----groundtrack-Molniya, echo = TRUE, eval = TRUE, out.width = "100%", fig.cap="Ground track of a Molniya satellite. The satellite spent most of the time over regions of high latitude.", fig.show='hold'----
...
## ----test-cases-sgdp4, echo = TRUE, eval = FALSE------------------------------
