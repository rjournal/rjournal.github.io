...
Figure [1](#fig:diagnose-example) summarizing key aspects of model fit:
...
<figure id="fig:diagnose-example" data-latex-placement="H">
<img src="figures/diagnose_neuralGAM.png" style="width:100.0%" />
...
Figures [2a](#fig:neural-model-plots)
and [2b](#fig:deepreg-model-plots) show the estimated partial effects
...
<figure id="fig:neural-model-plots">
...
<figure id="fig:deepreg-model-plots">
...
Figure [2b](#fig:deepreg-model-plots) displays centered partial
...
Figure [3](#fig:ensemble-deepregression) highlights this difference
...
(Figure [2a](#fig:neural-model-plots)),
[**deepregression**](https://CRAN.R-project.org/package=deepregression)
...
<figure id="fig:comparison-flights" data-latex-placement="h!">
<figure id="fig:neural-model-flights">
...
<figure id="fig:deepreg-airtime-binomial">
...
methods, Figure [4](#fig:comparison-flights) compares the estimated
partial effects of
[**neuralGAM**](https://CRAN.R-project.org/package=neuralGAM) and
[**deepregression**](https://CRAN.R-project.org/package=deepregression)
