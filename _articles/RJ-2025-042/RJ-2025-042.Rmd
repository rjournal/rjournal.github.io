...
effect is illustrated in Figure \@ref(ternary_plots), which shows how 5,000 random samples from
...
```{r phylocomparison, fig.cap="`phylotree_real`, `phylotree_alg2` and `phylotree_alg1`, from the left to the right.", out.width="100%", echo=FALSE}
