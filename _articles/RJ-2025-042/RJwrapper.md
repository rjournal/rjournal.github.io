...
bibliography:
- GeRnika.bib
title: "GeRnika: An R Package for the Simulation, Visualization and
  Comparison of Tumor Phylogenies"
---
...
effect is illustrated in Figure [1](#ternary_plots){reference-type="ref"
reference="ternary_plots"}, which shows how 5,000 random samples from
...
<figure id="ternary_plots">
<img src="figs/ternary_plots_cropped.png" style="width:100.0%"
alt="graphic without alt text" />
<figcaption>Figure 1: Ternary density plots of 5,000 samples drawn from
two 3-dimensional Dirichlet distributions. The parameters of the
Dirichlet distribution on the left are <span
class="math inline"><em>α</em></span> = (0.3, 0.3, 0.3) and the
distribution is used to represent positive selection-driven evolution.
The distribution on the right has parameters <span
class="math inline"><em>α</em></span> = (5, 10, 10) and is used to
...
proportions in each tree multifurcation.</figcaption>
</figure>
...
[2](#F_error_plot){reference-type="ref" reference="F_error_plot"}, we
...
<figure id="F_error_plot">
<img src="figs/noisy_F_error.png" style="width:100.0%"
alt="graphic without alt text" />
<figcaption>Figure 2: Density of the mean absolute error in noisy <span
class="math inline"><strong>F</strong></span> matrices for different
<span
class="math inline"><em>μ</em><sub><em>s</em><em>d</em></sub></span>
values that correspond to different noise levels.</figcaption>
</figure>
...
![Figure 3: Phylogenetic tree associated to the generated `"Phylotree"`
class object.](figs/phylotree.png){#fig:phylotree width="50.0%"
alt="graphic without alt text"}

The resulting plot is shown in Figure
[3](#fig:phylotree){reference-type="ref" reference="fig:phylotree"}.
...
![Figure 4: Phylogenetic trees associated to the generated `"Phylotree"`
class object, using the proportions associated to the previously
generated $\boldsymbol{U}$
matrix.](figs/proportions.png){#fig:proportions width="100%"
alt="graphic without alt text"}

The resulting plot is shown in Figure
[4](#fig:proportions){reference-type="ref" reference="fig:proportions"}.
...
depicted in Figure [5](#fig:phylocomparison){reference-type="ref"
reference="fig:phylocomparison"}.

![Figure 5: `phylotree_real`, `phylotree_alg2` and `phylotree_alg1`,
from the left to the
right.](figs/comparisonphylotrees.png){#fig:phylocomparison width="100%"
alt="graphic without alt text"}
...
![Figure 6: Maximal common subtrees between `phylotree_real` and
`phylotree_alg2` using predefined tags. In this case, there exists a
single common subtree, but there may exist more in other
cases.](figs/commonsubtrees.png){#fig:commonsubtrees width="100%"
alt="graphic without alt text"}

![Figure 7: Consensus tree between `phylotree_real` and `phylotree_alg1`
using the *Lancet* palette and predefined
tags.](figs/consensus.png){#fig:consensus width="40.0%"
alt="graphic without alt text"}

The maximal common subtrees (in this case, one subtree) between
`phylotree_real` and\
`phylotree_alg2` are shown in Figure
[6](#fig:commonsubtrees){reference-type="ref"
reference="fig:commonsubtrees"}. Note that the clones in the maximal
...
depicted in Figure [7](#fig:consensus){reference-type="ref"
reference="fig:consensus"}. Here, the nodes and the edges that compose
