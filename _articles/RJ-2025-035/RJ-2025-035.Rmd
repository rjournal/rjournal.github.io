...
abstract: |
  ...
  package [**movieROC**](https://CRAN.R-project.org/package=movieROC),
...
alt="graphic without alt text" />
<figcaption>Figure 1: R functions of the <a
...
alt="graphic without alt text" />
<figcaption>Figure 2: Density histograms and kernel density estimations
...
alt="graphic without alt text" />
<figcaption>Figure 3: Standard ROC curve (in gray) and gROC curve (in
black) empirical estimation for the capacity of genes 20202438, 18384097
and 03515901 to differ between tumor and non-tumor group.</figcaption>
</figure>
...
Figure [4](#fig:biroc){reference-type="ref" reference="fig:biroc"}
...
<figcaption>Figure 5: Multivariate ROC curve estimation for the
...
alt="graphic without alt text" />
<figcaption>Figure 6: Classification regions and the ROC curve (90º
...
<em>(C)</em> over the subsets (bottom).</figcaption>
</figure>
...
<figcaption>Figure 7: Different functional transformations and
...
gROC curve under restriction <em>(C)</em>.</figcaption>
</figure>
...
alt="graphic without alt text" />
<figcaption>Figure 8: Classification regions and the resulting ROC
...
restriction <em>(C)</em> for the original marker.</figcaption>
</figure>
