...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={\label{fig:pca-L}Yield loadings on the spanned factors. Example using bond yield data for Uruguay. Graph was generated using the ggplot2 package .}]{RJ-2025-044_files/figure-latex/pca-L-1.pdf}}
