...
(\#eq:ss)
\end{equation} 
The steady-state distribution is important because it extracts time-invariant information from a set of stochastic differential equations. Substituting the steady-state distribution to Eq \@ref(eq:Boltzmann) gives Wang's generalized potential landscape function [@wangPotentialLandscapeFlux2008] 
\begin{equation}
