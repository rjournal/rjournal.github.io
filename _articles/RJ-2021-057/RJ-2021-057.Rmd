...
In this case, it can be shown that $$\boldsymbol{J}= E \left[
		...
		\end{array}
	\right];$$ see [@FrancqZakoian2019 pp. 180-181]. In other words, in this
specific case, it is straightforward to obtain a numerical estimate of
...
of four GARCH models are compared: $$\begin{array}{llcl}
	...
	\end{array}$$ The parameters of the Data Generating Processes (DGPs) are
