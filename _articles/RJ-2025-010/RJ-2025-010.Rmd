...
abstract: |
  This article describes SimEngine, an
  ...
  simulations, but SimEngine is the
...
[5.6](#sec:mc_error){reference-type="ref" reference="sec:mc_error"}.
...
### Monte Carlo error {#sec:mc_error}
