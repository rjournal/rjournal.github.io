...
## ----boxplot, fig.width=11, out.width="100%", fig.cap="Cross-validation results for each normalization method, where our estimated normality statistic is plotted on the y-axis."----
