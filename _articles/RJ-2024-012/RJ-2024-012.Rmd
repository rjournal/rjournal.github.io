...
($\mu_1 (\text{cg\_GRHL3})= 0.2452019$). On the contrary, latent
cluster 2 features high levels of cg\_EPM2AIP1
($\mu_2 (\text{cg\_EPM2AIP1})=  0.303$) and cg\_VTRNA1\_3
($\mu_2 (\text{cg\_VTRNA1\_3})= 0.185$), and low levels of all other
