...
gb_4digits <-
  mvgb::pmvss(lower=rep(-2,5),
              ...
              Q=fitmv$mult_Q_posdef,
              delta=fitmv$univ_deltas,
              abseps = 1e-2,  ## 1e-4 in paper
              maxpts = 10000) ## 25000*350 in paper
tictoc::toc()
...
pd_4digits <-
  mvpd::pmvss(lower=rep(-2,5),
              ...
              Q=fitmv$mult_Q_posdef,
              delta=fitmv$univ_deltas,
              abseps.pmvnorm = 1e-3, ## 1e-6 in paper
              maxpts.pmvnorm = 10000, ## 25000*1000 in paper
              abs.tol.si = 1e-1) ## 1e-4 in paper
tictoc::toc()
pd_4digits[1]
