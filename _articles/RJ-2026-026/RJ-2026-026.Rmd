...
abstract: |
  ...
  [**nimblewomble**](https://CRAN.R-project.org/package=nimblewomble), a
  software package to perform wombling, or boundary analysis, using the
  [**nimble**](https://CRAN.R-project.org/package=nimble) Bayesian
...
|      |                       |                    | $\if 11{\boldsymbol{\mathbf{\theta}}}\fi\if 01{\theta}\fi$                                                                    |
|      +-----------------------+--------------------+-------------------------------------------------------------------------------------------------------------------------------+
|      | `zbeta_samples`       | model fitting      | Posterior samples for $Z(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi)$ and                                                 |
|      |                       |                    | $\if 11{\boldsymbol{\mathbf{\beta}}}\fi\if 01{\beta}\fi$                                                                      |
|      +-----------------------+--------------------+-------------------------------------------------------------------------------------------------------------------------------+
|      | `sprates`             | inference          | Posterior samples for                                                                                                         |
|      |                       |                    | $\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi Z(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi)$ and          |
|      |                       |                    | $\widetilde{\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi}^2Z(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi)$ |
|      +-----------------------+--------------------+-------------------------------------------------------------------------------------------------------------------------------+
|      | `spwombling`          | inference          | Posterior samples for $\if 11{\boldsymbol{\mathbf{\Gamma}}}\fi\if 01{\Gamma}\fi(C)$                                           |
|      +-----------------------+--------------------+-------------------------------------------------------------------------------------------------------------------------------+
...
We consider
$\{Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi): \if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi\in\mathscr{S}\subseteq\mathfrak{R}^2\}$
to be a univariate weakly stationary random field with zero mean and a
positive definite covariance
$K(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi, \if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi')= {\rm Cov}(Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi), Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi'))$
for locations
$\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi, \if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi'\in \mathfrak{R}^2$.
Mean square smoothness (see, e.g., Stein 1999) at an arbitrary location
$\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_0$ requires
$Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_0+h\if 11{\boldsymbol{\mathbf{u}}}\fi\if 01{u}\fi) = Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_0)+h\if 11{\boldsymbol{\mathbf{u}}}\fi\if 01{u}\fi^{\mathrm{\scriptscriptstyle T} }\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_0) + h^2 {\if 11{\boldsymbol{\mathbf{u}}}\fi\if 01{u}\fi^{\otimes 2}}^{\mathrm{\scriptscriptstyle T} }\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi^{\otimes 2}Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_0) + o(h^3||\if 11{\boldsymbol{\mathbf{u}}}\fi\if 01{u}\fi||^3)$,
where,
$\if 11{\boldsymbol{\mathbf{u}}}\fi\if 01{u}\fi=(u_1,u_2)^{\mathrm{\scriptscriptstyle T} }\in \mathfrak{R}^2$
is an arbitrary vector of directions,
$\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi$ is the
gradient operator,
$\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_0) = \left(\frac{\partial}{\partial s_x}Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_0),\frac{\partial}{\partial s_y}Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_0)\right)^{\mathrm{\scriptscriptstyle T} }=(\partial_xY(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_0), \partial_yY(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_0))^{\mathrm{\scriptscriptstyle T} }$,
$\otimes$ is the Kronecker vector product. Hence,
$\if 11{\boldsymbol{\mathbf{u}}}\fi\if 01{u}\fi^{\otimes 2}= \left(u_1^2, u_1u_2, u_2u_1, u_2^2\right)^{\mathrm{\scriptscriptstyle T} }$
and
$\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi^{\otimes 2} = \if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi\otimes \if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi$.
Note that
$\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi^{\otimes 2} Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_0)$
is the vectorized Hessian. The processes
$\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_0)$
and
$\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi^{\otimes 2}Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_0)$
govern rates of change in
$Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_0)$. The *gradient*,
...
$Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_0)$ guarantees that
$\if 11{\boldsymbol{\mathbf{u}}}\fi\if 01{u}\fi^{\mathrm{\scriptscriptstyle T} }\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_0)$
and
$(\if 11{\boldsymbol{\mathbf{u}}}\fi\if 01{u}\fi\otimes\if 11{\boldsymbol{\mathbf{v}}}\fi\if 01{v}\fi)^{\mathrm{\scriptscriptstyle T} }\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi^{\otimes 2}Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_0)$
are well-defined respectively, for any set of direction vectors
$\if 11{\boldsymbol{\mathbf{u}}}\fi\if 01{u}\fi, \if 11{\boldsymbol{\mathbf{v}}}\fi\if 01{v}\fi\in \mathfrak{R}^2$.
We note that the entries of
$\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi^{\otimes 2}Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_0)$
contain duplicates, both
$\partial^2_{xy}Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_0)=\frac{\partial^2}{\partial s_x\partial s_y}Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_0)$
and $\partial^2_{yx}Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_0)$
are included. To avoid singularities that arise from duplication, we
work with
$\widetilde{\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi}^{\otimes 2}Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_0)=\left(\partial_{xx}^2Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_0),\partial_{xy}^2Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_0), \partial_{yy}^2Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_0)\right)^{\mathrm{\scriptscriptstyle T} }$
comprised of only unique derivatives.

Statistical inference is devised for the joint process,
$\if 11{\boldsymbol{\mathbf{\mathcal{L}}}}\fi\if 01{\mathcal{L}}\fi^*Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi) = \left(Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi), \if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi)^{\mathrm{\scriptscriptstyle T} }, \widetilde{\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi}^{\otimes 2}Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi)^{\mathrm{\scriptscriptstyle T} }\right)^{\mathrm{\scriptscriptstyle T} }$.
Note that in $\mathfrak{R}^2$,
$\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi)$
and
$\widetilde{\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi}^{\otimes 2}Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi)$
...
al. 2024). The process
$\if 11{\boldsymbol{\mathbf{\mathcal{L}}}}\fi\if 01{\mathcal{L}}\fi^*Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi)$
is also weakly stationary with a cross-covariance matrix of order
$6\times 6$ given by,

$$\begin{equation}
\label{eq:cross-cov}
    \if 11{\boldsymbol{\mathbf{\mathrm{V}}}}\fi\if 01{V}\fi_{\if 11{\boldsymbol{\mathbf{\mathcal{L}}}}\fi\if 01{\mathcal{L}}\fi^*}(\if 11{\boldsymbol{\mathbf{\Delta}}}\fi\if 01{\Delta}\fi) =\left(\begin{array}{ccc}
        K(\if 11{\boldsymbol{\mathbf{\Delta}}}\fi\if 01{\Delta}\fi) &  \if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi K(\if 11{\boldsymbol{\mathbf{\Delta}}}\fi\if 01{\Delta}\fi)^{\mathrm{\scriptscriptstyle T} } & \widetilde{\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi}^2 K(\if 11{\boldsymbol{\mathbf{\Delta}}}\fi\if 01{\Delta}\fi)^{\mathrm{\scriptscriptstyle T} } \\
         -\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi K(\if 11{\boldsymbol{\mathbf{\Delta}}}\fi\if 01{\Delta}\fi) & -\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi^2K(\if 11{\boldsymbol{\mathbf{\Delta}}}\fi\if 01{\Delta}\fi) & -\widetilde{\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi}^3K(\if 11{\boldsymbol{\mathbf{\Delta}}}\fi\if 01{\Delta}\fi)^{\mathrm{\scriptscriptstyle T} }\\
         \widetilde{\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi}^{2}K(\if 11{\boldsymbol{\mathbf{\Delta}}}\fi\if 01{\Delta}\fi) & \widetilde{\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi}^3K(\if 11{\boldsymbol{\mathbf{\Delta}}}\fi\if 01{\Delta}\fi) & \widetilde{\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi}^4K(\if 11{\boldsymbol{\mathbf{\Delta}}}\fi\if 01{\Delta}\fi)
    \end{array}\right),
\end{equation}   (\#eq:cross-cov)$$
where
$\if 11{\boldsymbol{\mathbf{\Delta}}}\fi\if 01{\Delta}\fi= \if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi-\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi'$,
$\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi K(\if 11{\boldsymbol{\mathbf{\Delta}}}\fi\if 01{\Delta}\fi)$
is a $2\times 1$ vector of gradients,
$\widetilde{\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi}^2K(\if 11{\boldsymbol{\mathbf{\Delta}}}\fi\if 01{\Delta}\fi)$
is a $3\times 1$ vector of unique curvatures,
$\widetilde{\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi}^3K(\if 11{\boldsymbol{\mathbf{\Delta}}}\fi\if 01{\Delta}\fi)$
is a $3\times 2$ matrix of third derivatives,
$\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi^2K(\if 11{\boldsymbol{\mathbf{\Delta}}}\fi\if 01{\Delta}\fi)$
is the $2\times 2$ Hessian and
$\widetilde{\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi}^4K(\if 11{\boldsymbol{\mathbf{\Delta}}}\fi\if 01{\Delta}\fi)$
is a $3\times 3$ matrix of fourth-order derivatives. Evidently, for
$\if 11{\boldsymbol{\mathbf{\mathrm{V}}}}\fi\if 01{V}\fi_{\if 11{\boldsymbol{\mathbf{\mathcal{L}}}}\fi\if 01{\mathcal{L}}\fi^*}(\if 11{\boldsymbol{\mathbf{\Delta}}}\fi\if 01{\Delta}\fi)$
in \@ref(eq:cross-cov) to be valid all entries need to be well-defined.

Let
$Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi)\sim GP(0, K(\cdot;\if 11{\boldsymbol{\mathbf{\theta}}}\fi\if 01{\theta}\fi))$
denote a Gaussian process (GP) where
$K(\if 11{\boldsymbol{\mathbf{\Delta}}}\fi\if 01{\Delta}\fi;\if 11{\boldsymbol{\mathbf{\theta}}}\fi\if 01{\theta}\fi)= {\rm Cov}(Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi), Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi'))$
with process parameters
$\if 11{\boldsymbol{\mathbf{\theta}}}\fi\if 01{\theta}\fi= \{\sigma^2, \phi\}$.
We will denote
$K(\if 11{\boldsymbol{\mathbf{\Delta}}}\fi\if 01{\Delta}\fi;\if 11{\boldsymbol{\mathbf{\theta}}}\fi\if 01{\theta}\fi)=K(\if 11{\boldsymbol{\mathbf{\Delta}}}\fi\if 01{\Delta}\fi)$
to ease notation. The covariance function satisfies
$\sum_{i=1}^{N}\sum_{j=1}^{N}a_ia_jK(\if 11{\boldsymbol{\mathbf{\Delta}}}\fi\if 01{\Delta}\fi_{ij})>0$
for any collection of coordinates
$\{\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_i:i = 1,\ldots,N\}$.
Under isotropy we have
$K(\if 11{\boldsymbol{\mathbf{\Delta}}}\fi\if 01{\Delta}\fi)=\widetilde{K}(||\if 11{\boldsymbol{\mathbf{\Delta}}}\fi\if 01{\Delta}\fi||)$.
Let
$\if 11{\boldsymbol{\mathbf{\mathcal{Y}}}}\fi\if 01{\mathcal{Y}}\fi= \left(y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_1), \ldots, y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_N)\right)^{\mathrm{\scriptscriptstyle T} }$
be the observed realization over $\mathscr{S}$,
$\Sigma_\if 11{\boldsymbol{\mathbf{\mathcal{Y}}}}\fi\if 01{\mathcal{Y}}\fi$
be the $N\times N$ covariance matrix with entries
$K(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_i,\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_j)$,
$i, j = 1, \ldots, N$ and
$\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_0$ an arbitrary location
of interest. The joint distribution is as follows:

$$\begin{equation}
\label{eq:joint}
   \if 11{\boldsymbol{\mathbf{\mathcal{Y}}}}\fi\if 01{\mathcal{Y}}\fi, \if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_0), \widetilde{\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi}^2Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_0)\, | \;\if 11{\boldsymbol{\mathbf{\theta}}}\fi\if 01{\theta}\fi\sim  \mathcal{N}_{N+5}\left(\if 11{\boldsymbol{\mathbf{0}}}\fi\if 01{0}\fi_{N+5},\left(\begin{array}{ccc}
         \Sigma_\if 11{\boldsymbol{\mathbf{\mathcal{Y}}}}\fi\if 01{\mathcal{Y}}\fi& \if 11{\boldsymbol{\mathbf{\mathrm{K}}}}\fi\if 01{K}\fi_1 & \if 11{\boldsymbol{\mathbf{\mathrm{K}}}}\fi\if 01{K}\fi_2\\
         -\if 11{\boldsymbol{\mathbf{\mathrm{K}}}}\fi\if 01{K}\fi_1^{\mathrm{\scriptscriptstyle T} } & -\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi^2 K(\if 11{\boldsymbol{\mathbf{0}}}\fi\if 01{0}\fi) & -\widetilde{\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi}^3K(\if 11{\boldsymbol{\mathbf{0}}}\fi\if 01{0}\fi)^{\mathrm{\scriptscriptstyle T} }\\
         \if 11{\boldsymbol{\mathbf{\mathrm{K}}}}\fi\if 01{K}\fi_2^{\mathrm{\scriptscriptstyle T} } & \widetilde{\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi}^3K(\if 11{\boldsymbol{\mathbf{0}}}\fi\if 01{0}\fi) & \widetilde{\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi}^4K(\if 11{\boldsymbol{\mathbf{0}}}\fi\if 01{0}\fi)
    \end{array}\right)\right),
\end{equation}   (\#eq:joint)$$
where, $\mathcal{N}_d$ denotes the $d$-variate Gaussian distribution,
$\if 11{\boldsymbol{\mathbf{\mathrm{K}}}}\fi\if 01{K}\fi_1 = \left(\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi K(\delta_{10})^{\mathrm{\scriptscriptstyle T} },\ldots,\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi K(\delta_{N0})^{\mathrm{\scriptscriptstyle T} }\right)^{\mathrm{\scriptscriptstyle T} }$,
$\if 11{\boldsymbol{\mathbf{\mathrm{K}}}}\fi\if 01{K}\fi_2 = \left(\widetilde{\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi}^2 K(\delta_{10})^{\mathrm{\scriptscriptstyle T} },\ldots,\widetilde{\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi}^2 K(\delta_{N0})^{\mathrm{\scriptscriptstyle T} }\right)^{\mathrm{\scriptscriptstyle T} }$
and
$\delta_{i0} =\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_i-\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_0$,
$i = 1, \ldots, N$. The resulting posterior predictive distribution for
rates of change at $\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_0$ is
$P(\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_0),\widetilde{\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi}^2Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_0)\, | \;\if 11{\boldsymbol{\mathbf{\mathcal{Y}}}}\fi\if 01{\mathcal{Y}}\fi) = \int P(\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_0),\widetilde{\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi}^2Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_0)\, | \;\if 11{\boldsymbol{\mathbf{\mathcal{Y}}}}\fi\if 01{\mathcal{Y}}\fi,\if 11{\boldsymbol{\mathbf{\theta}}}\fi\if 01{\theta}\fi)\; P(\if 11{\boldsymbol{\mathbf{\theta}}}\fi\if 01{\theta}\fi\, | \;\if 11{\boldsymbol{\mathbf{\mathcal{Y}}}}\fi\if 01{\mathcal{Y}}\fi)\;d\if 11{\boldsymbol{\mathbf{\theta}}}\fi\if 01{\theta}\fi$.
Posterior sampling proceeds in a one-for-one fashion corresponding to
posterior samples of
$\if 11{\boldsymbol{\mathbf{\theta}}}\fi\if 01{\theta}\fi$. From
...
\label{eq:posterior_gradient}
    \left(\begin{array}{c}
         \if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_0) \\
         \widetilde{\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi}^2Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_0) 
    \end{array}\right)\, | \;\if 11{\boldsymbol{\mathbf{\mathcal{Y}}}}\fi\if 01{\mathcal{Y}}\fi\sim\mathcal{N}_5\left(-\left(\begin{array}{c}
         \if 11{\boldsymbol{\mathbf{\mathrm{K}}}}\fi\if 01{K}\fi_1 \\
         \if 11{\boldsymbol{\mathbf{\mathrm{K}}}}\fi\if 01{K}\fi_2 
    \end{array}\right)^{\mathrm{\scriptscriptstyle T} }\Sigma_\if 11{\boldsymbol{\mathbf{\mathcal{Y}}}}\fi\if 01{\mathcal{Y}}\fi^{-1}\if 11{\boldsymbol{\mathbf{\mathcal{Y}}}}\fi\if 01{\mathcal{Y}}\fi, \left(\begin{array}{cc}
         -\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi^2 K(\if 11{\boldsymbol{\mathbf{0}}}\fi\if 01{0}\fi) & -\widetilde{\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi}^3K(\if 11{\boldsymbol{\mathbf{0}}}\fi\if 01{0}\fi)^{\mathrm{\scriptscriptstyle T} } \\
         \widetilde{\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi}^3K(\if 11{\boldsymbol{\mathbf{0}}}\fi\if 01{0}\fi) & \widetilde{\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi}^4K(\if 11{\boldsymbol{\mathbf{0}}}\fi\if 01{0}\fi) 
    \end{array}\right)-\left(\begin{array}{c}
         \if 11{\boldsymbol{\mathbf{\mathrm{K}}}}\fi\if 01{K}\fi_1 \\
         \if 11{\boldsymbol{\mathbf{\mathrm{K}}}}\fi\if 01{K}\fi_2 
    \end{array}\right)^{\mathrm{\scriptscriptstyle T} }\Sigma_\if 11{\boldsymbol{\mathbf{\mathcal{Y}}}}\fi\if 01{\mathcal{Y}}\fi^{-1}\left(\begin{array}{c}
         \if 11{\boldsymbol{\mathbf{\mathrm{K}}}}\fi\if 01{K}\fi_1 \\
         \if 11{\boldsymbol{\mathbf{\mathrm{K}}}}\fi\if 01{K}\fi_2 
    \end{array}\right)\right).
\end{equation}   (\#eq:posterior-gradient)$$
We use the Matérn class of kernels,
$K(||\if 11{\boldsymbol{\mathbf{\Delta}}}\fi\if 01{\Delta}\fi||,\if 11{\boldsymbol{\mathbf{\theta}}}\fi\if 01{\theta}\fi) = \sigma^2\Gamma(\nu)^{-1}2^{1-\nu}\left(\sqrt{2\nu}\phi||\if 11{\boldsymbol{\mathbf{\Delta}}}\fi\if 01{\Delta}\fi||\right)^\nu K_\nu\left(\sqrt{2\nu}\phi||\if 11{\boldsymbol{\mathbf{\Delta}}}\fi\if 01{\Delta}\fi||\right)$,
...
\label{eq:wombling_measures}
    \if 11{\boldsymbol{\mathbf{\Gamma}}}\fi\if 01{\Gamma}\fi(C) = \left(\int_C \if 11{\boldsymbol{\mathbf{u}}}\fi\if 01{u}\fi^{\mathrm{\scriptscriptstyle T} }\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi)\;d\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi, \int_C{\if 11{\boldsymbol{\mathbf{u}}}\fi\if 01{u}\fi^{\otimes 2}}^{\mathrm{\scriptscriptstyle T} }\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi^{\otimes 2} Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi)\;d\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi\right)^{\mathrm{\scriptscriptstyle T} },
\end{equation}   (\#eq:wombling-measures)$$
where $C$ is a curve of interest to the investigator. Average wombling
measures are defined as
$\overline{\if 11{\boldsymbol{\mathbf{\Gamma}}}\fi\if 01{\Gamma}\fi}(C) = \if 11{\boldsymbol{\mathbf{\Gamma}}}\fi\if 01{\Gamma}\fi(C)/\ell(C)$,
...
the normal to $C$ at $\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi$ by
$\if 11{\boldsymbol{\mathbf{n}}}\fi\if 01{n}\fi(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi)$
and set
$\if 11{\boldsymbol{\mathbf{u}}}\fi\if 01{u}\fi= \if 11{\boldsymbol{\mathbf{n}}}\fi\if 01{n}\fi(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi)$
in the line integrals of \@ref(eq:wombling-measures). The curve $C$ is
deemed to be a *wombling boundary* if any entry of
$\if 11{\boldsymbol{\mathbf{\Gamma}}}\fi\if 01{\Gamma}\fi(C)$ is large.
Focusing on the choices for $C$, not all curves ensure the existence of
$\if 11{\boldsymbol{\mathbf{n}}}\fi\if 01{n}\fi(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi)$
at every $\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi$. Parametric
smooth curves offer some respite in that regard. We work with
$C = \{\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi(t) = (s_1(t), s_2(t)):t \in\mathcal{I}\subset \mathfrak{R}\}$.
As $t$ varies over $\mathcal{I}$,
$\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi(t)$ traces out $C$. We
assume $||\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi'(t)||\ne0$
which ensures
$\if 11{\boldsymbol{\mathbf{n}}}\fi\if 01{n}\fi(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi)=||\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi'(t)||^{-1}\left(s_2'(t), -s_1'(t)\right)^{\mathrm{\scriptscriptstyle T} }$
is well-defined.

The arc-length,
$\ell(C) = \int_\mathcal{I}||\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi'(t)||\;dt$.
For parametric curves
$\if 11{\boldsymbol{\mathbf{\Gamma}}}\fi\if 01{\Gamma}\fi(C)$ can be
expressed as,
$\if 11{\boldsymbol{\mathbf{\Gamma}}}\fi\if 01{\Gamma}\fi(C) = \left(\int_\mathcal{I}\if 11{\boldsymbol{\mathbf{n}}}\fi\if 01{n}\fi(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi(t))^{\mathrm{\scriptscriptstyle T} }\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi(t))||\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi'(t)||\;dt, \int_\mathcal{I}{\if 11{\boldsymbol{\mathbf{n}}}\fi\if 01{n}\fi(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi(t))^{\otimes 2}}^{\mathrm{\scriptscriptstyle T} }\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi^{\otimes 2} Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi(t))||\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi'(t)||\;dt\right)^{\mathrm{\scriptscriptstyle T} }$.
Let $\mathcal{I}= [0,t^*]$, and the curve traced out over $\mathcal{I}$
be denoted as $C_{t^*}$. Statistical inference for
$\if 11{\boldsymbol{\mathbf{\Gamma}}}\fi\if 01{\Gamma}\fi(C_{t^*})$
follows from
$\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi)$
and
$\widetilde{\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi}^2Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi)$
being GPs, as seen in \@ref(eq:posterior-gradient),
$\if 11{\boldsymbol{\mathbf{\Gamma}}}\fi\if 01{\Gamma}\fi(C_{t^*})\sim\mathcal{N}_2(\if 11{\boldsymbol{\mathbf{0}}}\fi\if 01{0}\fi_2, \if 11{\boldsymbol{\mathbf{\mathrm{K}}}}\fi\if 01{K}\fi_\if 11{\boldsymbol{\mathbf{\Gamma}}}\fi\if 01{\Gamma}\fi(t^*,t^*))$,
where
$\if 11{\boldsymbol{\mathbf{\mathrm{K}}}}\fi\if 01{K}\fi_\if 11{\boldsymbol{\mathbf{\Gamma}}}\fi\if 01{\Gamma}\fi(t^*,t^*)$
is a $2\times 2$ matrix with entries
$$\begin{equation}
\label{eq:variance_wm}
    k_{ij}(t^*,t^*)= (-1)^i\int_0^{t^*}\int_0^{t^*}\if 11{\boldsymbol{\mathbf{a}}}\fi\if 01{a}\fi_i(t_1)^{\mathrm{\scriptscriptstyle T} }\;\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi^{i+j}K(\if 11{\boldsymbol{\mathbf{\Delta}}}\fi\if 01{\Delta}\fi(t_1,t_2))\;\if 11{\boldsymbol{\mathbf{a}}}\fi\if 01{a}\fi_j(t_2)\;||\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi'(t_1)||\;||\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi'(t_2)||\;dt_1\;dt_2,
\end{equation}   (\#eq:variance-wm)$$
where
$\if 11{\boldsymbol{\mathbf{a}}}\fi\if 01{a}\fi_1(t)=\if 11{\boldsymbol{\mathbf{n}}}\fi\if 01{n}\fi(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi(t))$,
$\if 11{\boldsymbol{\mathbf{a}}}\fi\if 01{a}\fi_2(t)=\mathcal{E}_2\;\if 11{\boldsymbol{\mathbf{n}}}\fi\if 01{n}\fi(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi(t))^{\otimes 2}$,
with $\mathcal{E}_2= \left(\begin{smallmatrix}
        1 & & & \\ & 1 & 1 & \\ & & & 1
    \end{smallmatrix}\right)$ being an elimination matrix and
$\if 11{\boldsymbol{\mathbf{\Delta}}}\fi\if 01{\Delta}\fi(t_1,t_2)=\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_2(t)-\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_1(t)$
for $i,j = 1,2$. Predictive inference on
$\if 11{\boldsymbol{\mathbf{\Gamma}}}\fi\if 01{\Gamma}\fi(C)$ requires
$$\begin{equation}
\label{eq:joint-wm}
   \if 11{\boldsymbol{\mathbf{\mathcal{Y}}}}\fi\if 01{\mathcal{Y}}\fi, \if 11{\boldsymbol{\mathbf{\Gamma}}}\fi\if 01{\Gamma}\fi(C_{t^*})\, | \;\if 11{\boldsymbol{\mathbf{\theta}}}\fi\if 01{\theta}\fi\sim  \mathcal{N}_{N+2}\left(\if 11{\boldsymbol{\mathbf{0}}}\fi\if 01{0}\fi_{N+2},\left(\begin{array}{cc}
         \Sigma_\if 11{\boldsymbol{\mathbf{\mathcal{Y}}}}\fi\if 01{\mathcal{Y}}\fi& \if 11{\boldsymbol{\mathbf{\mathscr{G}}}}\fi\if 01{\mathscr{G}}\fi_\if 11{\boldsymbol{\mathbf{\Gamma}}}\fi\if 01{\Gamma}\fi(t^*)^{\mathrm{\scriptscriptstyle T} } \\
         \if 11{\boldsymbol{\mathbf{\mathscr{G}}}}\fi\if 01{\mathscr{G}}\fi_\if 11{\boldsymbol{\mathbf{\Gamma}}}\fi\if 01{\Gamma}\fi(t^*) & \if 11{\boldsymbol{\mathbf{\mathrm{K}}}}\fi\if 01{K}\fi_\if 11{\boldsymbol{\mathbf{\Gamma}}}\fi\if 01{\Gamma}\fi(t^*, t^*)
    \end{array}\right)\right),
\end{equation}   (\#eq:joint-wm)$$
where
$\if 11{\boldsymbol{\mathbf{\mathscr{G}}}}\fi\if 01{\mathscr{G}}\fi_\if 11{\boldsymbol{\mathbf{\Gamma}}}\fi\if 01{\Gamma}\fi(t^*)^{\mathrm{\scriptscriptstyle T} }=\left(\begin{smallmatrix}\if 11{\boldsymbol{\mathbf{\gamma}}}\fi\if 01{\gamma}\fi_1(t^*)^{\mathrm{\scriptscriptstyle T} } \\ \vdots \\\if 11{\boldsymbol{\mathbf{\gamma}}}\fi\if 01{\gamma}\fi_N(t^*)^{\mathrm{\scriptscriptstyle T} }\end{smallmatrix}\right)$
is an $N\times 2$ matrix with entries
$$\begin{equation}
\label{eq:cross-cov-wm}
    \gamma_i(t^*)=\left(\int_0^{t^*}\if 11{\boldsymbol{\mathbf{n}}}\fi\if 01{n}\fi(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi(t))^{\mathrm{\scriptscriptstyle T} } \if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi K(\if 11{\boldsymbol{\mathbf{\Delta}}}\fi\if 01{\Delta}\fi_j(t))\;||\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi'(t)||\;dt, \int_0^{t^*}{\if 11{\boldsymbol{\mathbf{n}}}\fi\if 01{n}\fi(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi(t))^{\otimes 2}}^{\mathrm{\scriptscriptstyle T} } \if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi^{\otimes 2} K(\if 11{\boldsymbol{\mathbf{\Delta}}}\fi\if 01{\Delta}\fi_j(t))\;||\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi'(t)||\;dt\right)^{\mathrm{\scriptscriptstyle T} },
\end{equation}   (\#eq:cross-cov-wm)$$
where
$\if 11{\boldsymbol{\mathbf{\Delta}}}\fi\if 01{\Delta}\fi_j(t) =  \if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi(t) - \if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_j$.
Posterior predictive inference proceeds one-for-one (similar to
\@ref(eq:posterior-gradient)) using
$\if 11{\boldsymbol{\mathbf{\Gamma}}}\fi\if 01{\Gamma}\fi(C_{t^*})\, | \;\if 11{\boldsymbol{\mathbf{\mathcal{Y}}}}\fi\if 01{\mathcal{Y}}\fi\sim \mathcal{N}_2\left(-\if 11{\boldsymbol{\mathbf{\mathscr{G}}}}\fi\if 01{\mathscr{G}}\fi_\if 11{\boldsymbol{\mathbf{\Gamma}}}\fi\if 01{\Gamma}\fi(t^*)\Sigma_\if 11{\boldsymbol{\mathbf{\mathcal{Y}}}}\fi\if 01{\mathcal{Y}}\fi^{-1}\if 11{\boldsymbol{\mathbf{\mathcal{Y}}}}\fi\if 01{\mathcal{Y}}\fi, \if 11{\boldsymbol{\mathbf{\mathrm{K}}}}\fi\if 01{K}\fi_\if 11{\boldsymbol{\mathbf{\Gamma}}}\fi\if 01{\Gamma}\fi(t^*, t^*) - \if 11{\boldsymbol{\mathbf{\mathscr{G}}}}\fi\if 01{\mathscr{G}}\fi_\if 11{\boldsymbol{\mathbf{\Gamma}}}\fi\if 01{\Gamma}\fi(t^*)\Sigma_\if 11{\boldsymbol{\mathbf{\mathcal{Y}}}}\fi\if 01{\mathcal{Y}}\fi^{-1}\if 11{\boldsymbol{\mathbf{\mathscr{G}}}}\fi\if 01{\mathscr{G}}\fi_\if 11{\boldsymbol{\mathbf{\Gamma}}}\fi\if 01{\Gamma}\fi(t^*)^{\mathrm{\scriptscriptstyle T} }\right)$.
...
Let
$C =\{\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi(t_0), \if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi(t_1), \ldots, \if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi(t_{n_p})\}$,
then the $i$-th segment,
$C_{t_i}=\{\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi(t) = \if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi(t_{i-1})+t\if 11{\boldsymbol{\mathbf{u}}}\fi\if 01{u}\fi_i:t\in[0,t_i]\}$,
$t_i = ||\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi(t_i)-\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi(t_{i-1})||$
and
$\if 11{\boldsymbol{\mathbf{u}}}\fi\if 01{u}\fi_i = t_i^{-1}(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi(t_i)-\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi(t_{i-1}))$.
Clearly, $||\if 11{\boldsymbol{\mathbf{u}}}\fi\if 01{u}\fi_i||=1$,
$||\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi'(t)||=1$ and the
normal to $C_{t_i}$ is
$\if 11{\boldsymbol{\mathbf{u}}}\fi\if 01{u}\fi_i^{\perp}=(u_{i2},-u_{i1})^{\mathrm{\scriptscriptstyle T} }$.
For predictive inference on
$\if 11{\boldsymbol{\mathbf{\Gamma}}}\fi\if 01{\Gamma}\fi(C_{t_i})$,
note that we need
$\if 11{\boldsymbol{\mathbf{\Delta}}}\fi\if 01{\Delta}\fi(t_1, t_2)=(t_2-t_1)\if 11{\boldsymbol{\mathbf{u}}}\fi\if 01{u}\fi_i$
in \@ref(eq:variance-wm) and
$\if 11{\boldsymbol{\mathbf{\Delta}}}\fi\if 01{\Delta}\fi_j(t)=\if 11{\boldsymbol{\mathbf{\Delta}}}\fi\if 01{\Delta}\fi_{i-1,j}+t\if 11{\boldsymbol{\mathbf{u}}}\fi\if 01{u}\fi_i=(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_{i-1}-\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_j) + t\if 11{\boldsymbol{\mathbf{u}}}\fi\if 01{u}\fi_{i-1}$
...
$$\begin{equation}
\label{eq:bhm}
        Y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi) = \mu(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi, \if 11{\boldsymbol{\mathbf{\beta}}}\fi\if 01{\beta}\fi)+Z(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi)+\epsilon(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi),
\end{equation}   (\#eq:bhm)$$
where
$\mu(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi,\if 11{\boldsymbol{\mathbf{\beta}}}\fi\if 01{\beta}\fi)=\if 11{\boldsymbol{\mathbf{x}}}\fi\if 01{x}\fi(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi)^{\mathrm{\scriptscriptstyle T} }\if 11{\boldsymbol{\mathbf{\beta}}}\fi\if 01{\beta}\fi$,
$Z(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi)\sim GP(0,K(\cdot;\sigma^2,\phi))$
and $\epsilon(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi)$ is a
white noise process (i.e.,
$\epsilon(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_i) \overset{iid}{\sim} N(0, \tau^2)$
over any finite collection of locations). The process parameters are
$\if 11{\boldsymbol{\mathbf{\theta}}}\fi\if 01{\theta}\fi=\{\sigma^2, \phi, \tau^2\}$.
Predictive inference for
$\if 11{\boldsymbol{\mathbf{\mathcal{L}}}}\fi\if 01{\mathcal{L}}\fi^*Z(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi)$
evaluates
$P(\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi Z(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi)^{\mathrm{\scriptscriptstyle T} }, \widetilde{\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi}^2Z(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi)^{\mathrm{\scriptscriptstyle T} }\, | \;\if 11{\boldsymbol{\mathbf{\mathcal{Y}}}}\fi\if 01{\mathcal{Y}}\fi)=\int P(\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi Z(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi)^{\mathrm{\scriptscriptstyle T} }, \widetilde{\if 11{\boldsymbol{\mathbf{\partial}}}\fi\if 01{\partial}\fi}^2Z(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi)^{\mathrm{\scriptscriptstyle T} }\, | \;\if 11{\boldsymbol{\mathbf{\mathcal{Z}}}}\fi\if 01{\mathcal{Z}}\fi,\if 11{\boldsymbol{\mathbf{\theta}}}\fi\if 01{\theta}\fi)\; P(\if 11{\boldsymbol{\mathbf{\mathcal{Z}}}}\fi\if 01{\mathcal{Z}}\fi\, | \;\if 11{\boldsymbol{\mathbf{\mathcal{Y}}}}\fi\if 01{\mathcal{Y}}\fi,\if 11{\boldsymbol{\mathbf{\theta}}}\fi\if 01{\theta}\fi)\; P(\if 11{\boldsymbol{\mathbf{\theta}}}\fi\if 01{\theta}\fi\, | \;\if 11{\boldsymbol{\mathbf{\mathcal{Y}}}}\fi\if 01{\mathcal{Y}}\fi)\;d\if 11{\boldsymbol{\mathbf{\theta}}}\fi\if 01{\theta}\fi\;d\if 11{\boldsymbol{\mathbf{\mathcal{Z}}}}\fi\if 01{\mathcal{Z}}\fi$.
Similarly for the wombling measures,
$P(\if 11{\boldsymbol{\mathbf{\Gamma}}}\fi\if 01{\Gamma}\fi_\if 11{\boldsymbol{\mathbf{\mathcal{Z}}}}\fi\if 01{\mathcal{Z}}\fi(C_{t^*})\, | \;\if 11{\boldsymbol{\mathbf{\mathcal{Y}}}}\fi\if 01{\mathcal{Y}}\fi)=\int P(\if 11{\boldsymbol{\mathbf{\Gamma}}}\fi\if 01{\Gamma}\fi_\if 11{\boldsymbol{\mathbf{\mathcal{Z}}}}\fi\if 01{\mathcal{Z}}\fi(C_{t^*})\, | \;\if 11{\boldsymbol{\mathbf{\mathcal{Z}}}}\fi\if 01{\mathcal{Z}}\fi,\if 11{\boldsymbol{\mathbf{\theta}}}\fi\if 01{\theta}\fi)\;P(\if 11{\boldsymbol{\mathbf{\mathcal{Z}}}}\fi\if 01{\mathcal{Z}}\fi\, | \;\if 11{\boldsymbol{\mathbf{\mathcal{Y}}}}\fi\if 01{\mathcal{Y}}\fi,\if 11{\boldsymbol{\mathbf{\theta}}}\fi\if 01{\theta}\fi)\;P(\if 11{\boldsymbol{\mathbf{\theta}}}\fi\if 01{\theta}\fi\, | \;\if 11{\boldsymbol{\mathbf{\mathcal{Y}}}}\fi\if 01{\mathcal{Y}}\fi)\;d\if 11{\boldsymbol{\mathbf{\theta}}}\fi\if 01{\theta}\fi\;d\if 11{\boldsymbol{\mathbf{\mathcal{Z}}}}\fi\if 01{\mathcal{Z}}\fi$.
A customary *collapsed* posterior, that is generated by marginalizing
$\if 11{\boldsymbol{\mathbf{\mathcal{Z}}}}\fi\if 01{\mathcal{Z}}\fi$
from the likelihood (see, e.g. Finley et al. 2019), for
$\if 11{\boldsymbol{\mathbf{\theta}}}\fi\if 01{\theta}\fi$ is specified
as follows:
$$\begin{equation}
\label{eq:full_posterior}
        P(\if 11{\boldsymbol{\mathbf{\theta}}}\fi\if 01{\theta}\fi\, | \;\if 11{\boldsymbol{\mathbf{\mathcal{Y}}}}\fi\if 01{\mathcal{Y}}\fi)\propto U(\phi\, | \;a_\phi,b_\phi)\times IG(\sigma^2\, | \;a_\sigma,b_\sigma)\times IG(\tau^2\, | \;a_\tau,b_\tau)\times \mathcal{N}_N(\if 11{\boldsymbol{\mathbf{\mathcal{Y}}}}\fi\if 01{\mathcal{Y}}\fi\, | \;\if 11{\boldsymbol{\mathbf{\mathrm{X}}}}\fi\if 01{X}\fi\if 11{\boldsymbol{\mathbf{\beta}}}\fi\if 01{\beta}\fi, \Sigma +\tau^2\if 11{\boldsymbol{\mathbf{\mathrm{I}}}}\fi\if 01{I}\fi_N),
\end{equation}   (\#eq:full-posterior)$$
where
$\Sigma = \sigma^2\if 11{\boldsymbol{\mathbf{\mathrm{R}}}}\fi\if 01{R}\fi_\if 11{\boldsymbol{\mathbf{\mathcal{Z}}}}\fi\if 01{\mathcal{Z}}\fi(\phi)$,
with
$\if 11{\boldsymbol{\mathbf{\mathrm{R}}}}\fi\if 01{R}\fi_\if 11{\boldsymbol{\mathbf{\mathcal{Z}}}}\fi\if 01{\mathcal{Z}}\fi(\phi)$
...
$\if 11{\boldsymbol{\mathbf{\theta}}}\fi\if 01{\theta}\fi$. Posterior
samples for
$\if 11{\boldsymbol{\mathbf{\mathcal{Z}}}}\fi\if 01{\mathcal{Z}}\fi$ and
$\if 11{\boldsymbol{\mathbf{\beta}}}\fi\if 01{\beta}\fi$ are generated
one-for-one corresponding to posterior samples of
$\if 11{\boldsymbol{\mathbf{\theta}}}\fi\if 01{\theta}\fi$ using a Gibbs
sampling scheme.
...
$y(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi)\sim \mathcal{N}_1\left(\mu_0(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi) = 20\sin||\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi||, \tau^2\right)$.
We set $\tau^2 = 1$. Here, the true values of gradients are available in
closed form. For example,
$\partial_x \mu_0(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_G)=20\cos||\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_G||\;s_{x,G}\;||\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_G||^{-1}$,
where
$\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi_G =(s_{x,G}, s_{y,G})$
...
$\mu_0(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi)$. Running the
...
$Z(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi)$ and
$\if 11{\boldsymbol{\mathbf{\beta}}}\fi\if 01{\beta}\fi$ one-for-one
with $\if 11{\boldsymbol{\mathbf{\theta}}}\fi\if 01{\theta}\fi$. The
`mc_sp` object is a `list` comprised of (a) MCMC samples for
$\if 11{\boldsymbol{\mathbf{\theta}}}\fi\if 01{\theta}\fi$ stored in
`mc_sp$mcmc` and (b) the estimates: median and 95% confidence intervals
(CIs) stored in `mc_sp$estimates`. Posterior samples for
$Z(\if 11{\boldsymbol{\mathbf{s}}}\fi\if 01{s}\fi)$ and
$\if 11{\boldsymbol{\mathbf{\beta}}}\fi\if 01{\beta}\fi$ are obtained
using `zbeta_samples` as seen below. The `model` object contains samples
for $\if 11{\boldsymbol{\mathbf{\theta}}}\fi\if 01{\theta}\fi$,
$\if 11{\boldsymbol{\mathbf{\mathcal{Z}}}}\fi\if 01{\mathcal{Z}}\fi$ and
$\if 11{\boldsymbol{\mathbf{\beta}}}\fi\if 01{\beta}\fi$.
...
Posterior samples of
$\if 11{\boldsymbol{\mathbf{\Gamma}}}\fi\if 01{\Gamma}\fi(C)$, where $C$
...
$\if 11{\boldsymbol{\mathbf{\Gamma}}}\fi\if 01{\Gamma}\fi(C)$ and
...
wombling measure,
$\widehat{\if 11{\boldsymbol{\mathbf{\Gamma}}}\fi\if 01{\Gamma}\fi(C)}=(-108.765, 154.565)^{\mathrm{\scriptscriptstyle T} }$,
with 95% CIs being $(-182.098, -36.290)$ and $(69.053, 241.664)$
respectively, containing the true values
$\if 11{\boldsymbol{\mathbf{\Gamma}}}\fi\if 01{\Gamma}\fi(C)=(-131.149, 144.010)^{\mathrm{\scriptscriptstyle T} }$.
...
$\widehat{\if 11{\boldsymbol{\mathbf{\Gamma}}}\fi\if 01{\Gamma}\fi}(C)=(18.176, -8.976)^{\mathrm{\scriptscriptstyle T} }$
