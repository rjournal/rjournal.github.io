...
- [x] used array instead of pmatrix for matrices
...
- [x] DOES NOT use  booktabs  format  for  tables
...
- [ ] first citation of a package DOES NOT use \\CRANpkg, or \\BIOpkg, or further mentions of R packages DO NOT only use \\pkg
...
heinen2003 is not a correct citation
