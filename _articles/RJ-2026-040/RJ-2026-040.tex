...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={\label{fig:base-fcst}Forecasts: Actual values (black) and fitted/out-of-sample forecasts (blue) from model (a) with the default setting (left, sMAPE = 3.51\%) and model (b) with stronger regularization (right, sMAPE = 7.75\%). The vertical dashed line marks the split between training and test data. Stronger regularization yields a more dampened forecast compared to the default model.}]{RJ-2026-040_files/figure-latex/base-fcst-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={\label{fig:tidy-model-fcst}Actual values (black) and out-of-sample forecasts from the ESN model (blue) and ARIMA model (orange) for the time series M21655 and M2717.}]{RJ-2026-040_files/figure-latex/tidy-model-fcst-1.pdf}}
