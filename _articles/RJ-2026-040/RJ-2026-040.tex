...
{\centering \includegraphics[width=1\linewidth]{figures/figure_01_esn_architecture} 
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{RJ-2026-040_files/RJ-2026-040_files/figure-latex/synthetic-data-1.pdf}}
\caption{\label{fig:synthetic-data}\textbf{Synthetic data:} Actual values (black), fitted values (orange), and out-of-sample forecasts (blue) from automatic ESN models (default setting) for the synthetic time series in the dataset \texttt{synthetic\_data}. The vertical dotted line indicates the split of the actual values into training and testing data.}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{RJ-2026-040_files/RJ-2026-040_files/figure-latex/example-data-1.pdf}}
\caption{\label{fig:example-data}\textbf{Real-world data:} Actual values (black), fitted values (orange), and out-of-sample forecasts (blue) from automatic ESN models (default setting) for four selected time series from the dataset \texttt{m4\_monthly\_subset}. The vertical dotted line indicates the split of the actual values into training and testing data.}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{RJ-2026-040_files/RJ-2026-040_files/figure-latex/pars-reservoir-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{RJ-2026-040_files/RJ-2026-040_files/figure-latex/pars-forecast-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{RJ-2026-040_files/RJ-2026-040_files/figure-latex/sample-size-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{RJ-2026-040_files/RJ-2026-040_files/figure-latex/base-fcst-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{RJ-2026-040_files/RJ-2026-040_files/figure-latex/base-reservoir-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{RJ-2026-040_files/RJ-2026-040_files/figure-latex/base-tune-1.pdf}}
\caption{\label{fig:base-tune}\textbf{Hyperparameter tuning:} Time series cross-validation results from \texttt{tune\_esn()} with out-of-sample forecasts and five splits by default: (a) Evaluation of a single fixed setting with low spectral radius (left) and (b) tuning the spectral radius, where the best configuration is selected automatically based on average MSE across splits (right).}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{RJ-2026-040_files/RJ-2026-040_files/figure-latex/tidy-model-fcst-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{RJ-2026-040_files/RJ-2026-040_files/figure-latex/tidy-model-residuals-1.pdf}}
