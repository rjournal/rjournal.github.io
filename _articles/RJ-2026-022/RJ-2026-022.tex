...
\title{highlightr: Creating Highlighted Text Based on Source Frequency}
...
Similarly, \citet{janicke_visualizations_2014} utilize visualization tools in JavaScript to compare versions of the Bible for text reuse at a sentence level.
...
Other objects that include a column for the desired text, word order, and value of interest can also be inputted into \texttt{collocation\_plot()} to generate color values for each word.
...
\begin{figure}
\includegraphics[width=1\linewidth,alt={Flowchart of average collocation calculation process. The single word 'interest' has arrows indicating its presence in 5 collocations. These collocations each lead to a single frequency value, which then connect to the average value.}]{RJ-2026-022_files/figure-latex/collocateflowchart-1} \caption{A flowchart of the collocation process for the word 'interest' with collocation length 5.}\label{fig:collocateflowchart}
\end{figure}
...
Two tuning adjustments that can be made in the case of fuzzy matching are a change in n-gram width (specified through \texttt{n\_gram\_width}) and a change in the threshold of what is considered a match (specified through \texttt{threshold}).
...
\begin{figure}
\includegraphics[width=1\linewidth,alt={A plot of smoothness by collocation length. Y axis shows the sum of adjacent word frequency distance squared, while x shows the collocation length.}]{RJ-2026-022_files/figure-latex/abstract-smooth-1} \caption{Smoothness of Summary Highlighting in Abstract Example}\label{fig:abstract-smooth}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth,alt={Histogram of edit count between April 22, 2023 and August 29, 2024. Colored bars below the histogram indicate the date ranges used in analysis, and a vertical line indicates the date of the nomination announcement.}]{RJ-2026-022_files/figure-latex/walz-freq-1} \caption{Number of Edits between April 22, 2023 and August 29, 2024. Sample 1, corresponding to articles before nomination, ranges from April 21, 2023 to July 31, 2024. Sample 2, corresponding to articles after nomination, ranges from August 18, 2024 to August 29, 2024. The red line indicates the date Walz's nomination was announced (August 6, 2024).}\label{fig:walz-freq}
\end{figure}
...
{\centering \includegraphics[width=0.31\linewidth,alt={Images of the oldest and newest versions of Walz articles in the dataset with highlighting.}]{figures/walz_newest_article} \includegraphics[width=0.31\linewidth,alt={Images of the oldest and newest versions of Walz articles in the dataset with highlighting.}]{figures/walz_oldest_article} 
...
{\centering \includegraphics[width=1\linewidth,alt={Highlighted image of exerpts relating to former presidents. Highlighting uses a gradient from purple (low frequency) to yellow (high frequency).}]{figures/walz_presidential} 
