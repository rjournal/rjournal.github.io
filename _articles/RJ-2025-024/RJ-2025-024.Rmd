---
title: 'QTE.RD: An R Package for Quantile Treatment Effects in Regression-Discontinuity
  Designs'
abstract: |
...
- name: Jungmo Yoon
  affiliation: College of Economics and Finance
  address:
  - Hanyang University
  - Korea, South
...
::: {#tab:T1}
Table: Table 1: Comparisons of R/Stata packages and functions
...
| quantreg.nonpar        | R                    | CI              | ✗                | uniform   | ✓               | QR               | Series            |
