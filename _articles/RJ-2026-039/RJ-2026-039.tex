...
\begin{table}[!h]
\centering
\caption{\label{tab:admixEstimArgs-latex}Arguments of the function admix\textbackslash{}\_estim().}
\centering
\fontsize{8}{10}\selectfont
\begin{tabular}[t]{ll}
\toprule
...
\begin{table}[!h]
\centering
\caption{\label{tab:admixTestArgs-latex}Arguments of the function admix\textbackslash{}\_test().}
\centering
\fontsize{8}{10}\selectfont
\begin{tabular}[t]{ll}
\toprule
...
\begin{table}[!h]
\centering
\caption{\label{tab:admixClusterArgs-latex}Arguments of the function admix\textbackslash{}\_cluster().}
\centering
\fontsize{8}{10}\selectfont
\begin{tabular}[t]{ll}
\toprule
