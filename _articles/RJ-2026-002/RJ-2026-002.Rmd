...
The \CRANpkg{gasmodel} package is accessible on CRAN at [cran.r-project.org/package=gasmodel](https://cran.r-project.org/web/packages/gasmodel/index.html). Additionally, users can find the development version of the package on GitHub at [github.com/vladimirholy/gasmodel](https://github.com/vladimirholy/gasmodel), providing them with the opportunity to report any bugs or issues they encounter.
