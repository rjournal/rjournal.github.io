...
- |
  ...
  United States\
author:
- by Yanqi Zhang, Chong Wang, Annette O'Connor
bibliography:
- NMAforest_RJournal.bib
title: "NMAforest: An R Package for Generating Forest Plots in Network
  Meta-Analysis with Decomposition of Direct, Indirect, and Study-Level
...
[zyq1998@iastate.edu](zyq1998@iastate.edu){.uri}

[chwang@iastate.edu](chwang@iastate.edu){.uri}

[oconn445@msu.edu](oconn445@msu.edu){.uri}
:::
...
Simon G. Thompson, and Ades A. E. 2011. "Linear Inference for Mixed
