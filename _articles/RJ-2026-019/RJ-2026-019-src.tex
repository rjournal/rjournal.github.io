...
This idea has been broadly applied, for example, to generalized linear models \citep{tibshirani1996regression} and Cox proportional hazard models for survival data \citep{tibshirani1997lasso}.
