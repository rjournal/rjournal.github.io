---
title: 'FuzzySimRes: Epistemic Bootstrap -- an Efficient Tool for Statistical Inference
...
Fig. \@ref(fig:figN100pvalue1)) and power curves (see Fig.
\@ref(fig:figN100power1)) for the moderate sample of TPFNs
...
```{r figN100pvalue1, echo=FALSE , fig.cap="Estimated p-values of the two-sample epistemic and ``crisp'' KS tests for $\\mathbb{F}_{(\\mathrm{N,U,U,U})}, n=100$, and shift in location.", fig.alt="graphic without alt text", fig.show='hold', fig.align="center", out.width="100%"}
knitr::include_graphics(c("pvalue_N100_rys01.png"))
```
...
knitr::include_graphics(c("diff_pvalue_N100_rys01.png"))
```

```{r figN100power1, echo=FALSE , fig.cap="Power curves of the two-sample epistemic and “crisp” KS tests for $\\mathbb{F}_{(\\mathrm{N,U,U,U})}$, n=100, and shift in location.", fig.alt="graphic without alt text", fig.show='hold', fig.align="center", out.width="100%"}
knitr::include_graphics(c("power_N100_rys01.png"))
```
...
knitr::include_graphics(c("diff_power_N100_rys01.png"))
```
...
\@ref(fig:figN100pvaluesd1) and
\@ref(fig:figN100powersd1)) were estimated for the moderate
...
```{r figN100pvaluesd1, echo=FALSE , fig.cap="Estimated p-values of the two-sample epistemic and “crisp” KS tests for $\\mathbb{F}_{(\\mathrm{N,U,U,U})}$, n=100, difference in scale.", fig.alt="graphic without alt text", fig.show='hold', fig.align="center", out.width="100%"}
knitr::include_graphics(c("pvalue_sd_N100_rys01.png"))
```
...
knitr::include_graphics(c("diff_pvalue_sd_N100_rys01.png"))
```

```{r figN100powersd1, echo=FALSE , fig.cap="Power curves of the two-sample epistemic and “crisp” KS tests for $\\mathbb{F}_{(\\mathrm{N,U,U,U})}$, n=100, difference in scale.", fig.alt="graphic without alt text", fig.show='hold', fig.align="center", out.width="100%"}
knitr::include_graphics(c("power_sd_N100_rys01.png"))
```
...
knitr::include_graphics(c("diff_power_sd_N100_rys01.png"))
```
