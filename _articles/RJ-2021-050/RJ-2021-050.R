...
# Please edit RJ-2021-050.Rmd to modify this file
...
## ----wrap-ped-html, fig.show = "hold", fig.cap = "Animations showing wrapping after slicing the \\code{pedestrian20} data at different intervals, including daily and weekly. This type of interaction is made possible with Shiny elements.", eval = knitr::is_html_output()----
