...
abstract: |
  This article presents an overview of the bartcs R package, which
...
- name: Chanmin Kim (corresponding author)
  affiliation: Department of Statistics, SungKyunKwan University
...
[@BART] under the GPL license, with modifications. In particular, the
...
samples from
$P(\mathcal{T}_1^a, \cdots, \mathcal{T}_T^a,  \mathcal{M}_1^a, \cdots, \mathcal{M}_T^a, \sigma^2_a | \boldsymbol{D})$
...
[coda](https://cran.r-project.org/package=coda) package [@RCODA;@coda] for a
...
[coda](https://cran.r-project.org/package=coda) R package [@RCODA;@coda]. The
