...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={(\#fig:BiclusteringArray\_plot)Array plot comparing original response patterns (left) and reorganized patterns after ranklustering (right). Black cells indicate correct responses and white cells indicate incorrect responses.}]{RJ-2026-023_files/RJ-2026-023_files/figure-latex/BiclusteringArray_plot-1.pdf}}
\caption{(\#fig:BiclusteringArray\_plot)Array plot comparing original response patterns (left) and reorganized patterns after ranklustering (right). Black cells indicate correct responses and white cells indicate incorrect responses.}
\end{figure}
...
Koji Kosugi\\
Senshu University\\%
School of Human Sciences\\ 2-1-1, Higashi-mita, Tama-ku, Kanagawa Pref, Japan\\
%
