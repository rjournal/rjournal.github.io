...
```{r BiclusteringArray-plot, echo=TRUE, fig.cap='Array plot comparing original response patterns (left) and reorganized patterns after ranklustering (right). Black cells indicate correct responses and white cells indicate incorrect responses.'}
