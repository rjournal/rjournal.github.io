...
\item
  \code{qic.select()} takes an `\code{rq.pen.seq}' or `\code{rq.pen.seq.cv}' object and provides the optimal values of \((\lambda,a)\) using an information criterion, as explained in the previous section. It returns an `\code{qic.select}' S3 object that works with \code{coef()}, \code{predict()}, and \code{print()} methods.
\item
  \code{bytau.plot()} plots coefficients estimates for each predictor as a function of \(\tau\).
\end{itemize}
...
\begin{center}\includegraphics[width=250px,height=250px]{rqPenRJ_files/figure-latex/unnamed-chunk-10-1} \end{center}
...
\begin{center}\includegraphics[width=250px,height=250px]{rqPenRJ_files/figure-latex/unnamed-chunk-12-1} \end{center}
...
\begin{center}\includegraphics[width=250px,height=250px]{rqPenRJ_files/figure-latex/unnamed-chunk-20-1} \end{center}
...
\begin{center}\includegraphics[width=250px,height=250px]{rqPenRJ_files/figure-latex/unnamed-chunk-21-1} \end{center}
...
\begin{center}\includegraphics[width=250px,height=250px]{rqPenRJ_files/figure-latex/unnamed-chunk-29-1} \end{center}

\begin{verbatim}
plot(qAmes2,tau=.5)
\end{verbatim}

\begin{center}\includegraphics[width=250px,height=250px]{rqPenRJ_files/figure-latex/unnamed-chunk-29-2} \end{center}
...
\begin{center}\includegraphics[width=250px,height=250px]{rqPenRJ_files/figure-latex/unnamed-chunk-31-1} \end{center}
...
\begin{center}\includegraphics[width=250px,height=250px]{rqPenRJ_files/figure-latex/unnamed-chunk-33-1} \end{center}
