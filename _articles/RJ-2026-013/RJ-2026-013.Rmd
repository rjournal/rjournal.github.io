...
<img src="figures/data.table-atime_versions.png" style="width:50%" /><img src="figures/data.table-atime_test.png" style="width:50%" />
...
[`Parent of the first commit`](https://github.com/Rdatatable/data.table/commit/0f0e7127b880df8459b0ed064dc841acd22f5b73){.uri} in the PR (<https://github.com/Rdatatable/data.table/pull/4440/commits>) that improves speed`.
