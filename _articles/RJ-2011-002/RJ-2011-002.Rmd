...
<span id="cb1-3"><a href="#cb1-3" aria-hidden="true" tabindex="-1"></a>\textcolor{green}{.........}</span>
...
<span id="cb1-12"><a href="#cb1-12" aria-hidden="true" tabindex="-1"></a>\textcolor{green}{...}\textcolor{red}{<span class="dv">12</span>}\textcolor{green}{..}\textcolor{red}{<span class="dv">34</span>}</span>
<span id="cb1-13"><a href="#cb1-13" aria-hidden="true" tabindex="-1"></a></span>
<span id="cb1-14"><a href="#cb1-14" aria-hidden="true" tabindex="-1"></a>\textcolor{red}{<span class="fl">1.</span> Failure<span class="sc">:</span> nchar of missing is missing} <span class="sc">---------------------------------</span></span>
...
<span id="cb1-18"><a href="#cb1-18" aria-hidden="true" tabindex="-1"></a>\textcolor{red}{<span class="fl">2.</span> Failure<span class="sc">:</span> nchar of missing is missing} <span class="sc">---------------------------------</span></span>
...
<span id="cb1-22"><a href="#cb1-22" aria-hidden="true" tabindex="-1"></a>\textcolor{red}{<span class="fl">3.</span> Failure<span class="sc">:</span> nchar of factor is length of level} <span class="sc">---------------------------------</span></span>
...
<span id="cb1-26"><a href="#cb1-26" aria-hidden="true" tabindex="-1"></a>\textcolor{red}{<span class="fl">4.</span> Failure<span class="sc">:</span> nchar of factor is length of level} <span class="sc">---------------------------------</span></span>
...
``` r
> test_dir("inst/tests/")
String and pattern checks : \textcolor{green}{......}
Detecting patterns : \textcolor{green}{.........}
Duplicating strings : \textcolor{green}{......}
Extract patterns : \textcolor{green}{..}
Joining strings : \textcolor{green}{......}
String length : \textcolor{green}{.........}
Locations : \textcolor{green}{............}
Matching groups : \textcolor{green}{..............}
Test padding : \textcolor{green}{....}
Splitting strings : \textcolor{green}{.........................}
Extracting substrings : \textcolor{green}{...................}
Trimming strings : \textcolor{green}{........}
```
