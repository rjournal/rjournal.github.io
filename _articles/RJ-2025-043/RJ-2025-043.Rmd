...
```{r figurememshare, out.width = "100%", fig.cap = "A schematic about where the memory is located and how different sessions access it.", echo=FALSE}
...
## Appendix A: code listing of benchmark {.appendix}
...
## Appendix B: ALTREP and shared memory in R {.appendix}
...
## Appendix C: benchmarking in detail {.appendix}
...
```{r appendix-figure1, out.width = "100%", fig.cap = "Median runtime (log-scale) vs matrix size for `memshare`, `SharedObject`, and serial baseline; ribbons show IQR across 100 runs. Insets show the difference in total RSS in log(MB) (i.e., memory overhead) during the run relative to idle for Windows~10 via Boot Camp.", echo=FALSE}
knitr::include_graphics("figures/Figure1_appendix_secs_vs_Resident_Set_Size_win.png")
```

## Appendix D: screenshot {.appendix}
...
```{r app-a-1, out.width = "100%", fig.cap = "First Screenshot of ShareObjects Computation.", echo=FALSE}
knitr::include_graphics("figures/Crash_message1.png")
```

```{r app-a-2, out.width = "100%", fig.cap = "Second Screenshot of ShareObjects Computation.", echo=FALSE}
