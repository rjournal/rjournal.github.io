...
# Please edit ms.Rmd to modify this file
...
## ----echo=run_level==1,eval=run_level==1--------------------------------------
...
## ----echo=run_level==3,eval=run_level==3--------------------------------------
starts <- runif_panel_design(
  lower = c('r' = 0.05, 'sigma' = 0.05, 'tau' = 0.05, 'K' = 1, 'X.0' = 1),
  upper = c('r' =  0.2, 'sigma' =  0.2, 'tau' =  0.2, 'K' = 1, 'X.0' = 1),
  specific_names = c('K', 'tau', 'X.0'),
...
## ----block_func1, eval=run_level==1, echo=run_level==1------------------------
...
## ----block_func3, eval=run_level==3, echo=run_level==3------------------------
