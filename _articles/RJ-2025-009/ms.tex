...
\begin{center}\includegraphics{ms_files/figure-latex/plotMeas-1} \end{center}

\begin{center}\includegraphics{ms_files/figure-latex/plotMeas-2} \end{center}
...
{\centering \includegraphics{ms_files/figure-latex/mcap-plot-1} 
