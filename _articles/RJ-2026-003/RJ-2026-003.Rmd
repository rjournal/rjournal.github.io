...
-   The MPI can also be calculated as the weighted sum of the *Censored Indicators Headcounts Ratios*, $h_j(k)$, for $j=1,\ldots,d$. This is clearer by rearranging the order of aggregation in the original $M_0$ equation (1). This is, \begin{align}
