...
```{r cast-packages-html, eval = knitr::is_html_output(), layout = "l-body-outset"}
...
```{r math-operators-html, eval = knitr::is_html_output(), layout = "l-body-outset"}
...
```{r complex-operators-html, eval = knitr::is_html_output(), layout = "l-body-outset"}
