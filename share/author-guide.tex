...
\item Create a minimal \file{Yourlastname.bib} BibTeX file with only the entries you need, without unnecessary fields such as abstracts, and add
...
\verb|url = {https://doi.org/...}| be used in preference to \verb|doi = {...}|, to use secure redirection.
