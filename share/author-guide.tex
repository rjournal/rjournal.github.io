...
desirable whenever a referenced item has a DOI; recent practice prefers 
\verb|url = {https://doi.org/...}| to \verb|doi = {...}|, to use secure 
redirection.
...
mentioned in the article in the bibliography using \code{toBibtex(citation())} 
to produce the required entry.
...
be produced using \code{toBibtex(citation())}.
