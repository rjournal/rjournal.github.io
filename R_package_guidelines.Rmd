...
* The package is actively maintained and sufficiently mature.

### Common reasons for desk rejection

* Lack of evidence that the package is actively maintained and sufficiently mature, including its length of time on CRAN, release history, recent updates, and ongoing development activity.
* The package is not sufficiently substantial, with its core functionality readily achievable using existing systems and and only limited additional value provided.
* Lack of compelling evidence that the package will be of broader interest to the R community. The fact that a method has not previously been implemented in R is not, by itself, a compelling justification.
* The package addresses a niche application that may be better suited to a domain-specific journal.
* Insufficient comparison with existing R packages or alternative approaches.
* The manuscript does not clearly establish the package’s novelty, contribution, or advantages over existing solutions.
