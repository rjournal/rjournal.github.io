...
_Please note that we plan to introduce a Quarto article template in the future to replace the current R Markdown template, and authors will be expected to use the Quarto template for new submissions once it is introduced._
...
- `initial_check_article()` does multiple checks on the files in your paper submission folder
    ...
    - `check_packages_available()` additionally referenced packaged are also available on CRAN or Bioconductor
