...
{\centering \includegraphics[width=0.8\linewidth,alt={Diagram showing two normal distributions relative to the lower specification limit L. Vertical lines mark the acceptance criterion A. Shaded areas under the tails represent the proportions nonconforming at PRQ and CRQ.}]{figures/Density_2_points_estimation} 
...
{\centering \includegraphics[width=0.8\linewidth,alt={Operating characteristic curve for Vitamin A Beta-based sampling. The curve slopes downward, showing decreasing probability of acceptance as the proportion nonconforming increases. Vertical dashed lines are drawn at 2.5\% and 10\% to indicate PRQ and CRQ levels. Horizontal dashed lines at 95\% and 10\% indicate the producer’s and consumer’s risk probability constraints.}]{ha-truong-AccSamplingDesign_files/figure-latex/fig-vitA-OC-1} 
...
{\centering \includegraphics[width=0.8\linewidth,alt={Line plot of the operating characteristic curve for Vitamin A Beta-based sampling, illustrating how the probability of acceptance changes as the process mean varies. Vertical dashed lines mark the mean levels corresponding to the producer’s risk quality and consumer’s risk quality. Horizontal dashed lines at 95\% and 10\% indicate the producer’s and consumer’s risk probability constraints.}]{ha-truong-AccSamplingDesign_files/figure-latex/fig-vitA-OC-mean-1} 
...
{\centering \includegraphics[width=1\linewidth,alt={Line plot of OC curves showing probability of acceptance versus proportion nonconforming. The optimal plan is compared with plans using n + 10 and k + 0.1. The plot highlights how changes in n or k affect the slope and shape of the curve, impacting producer’s and consumer’s risks.}]{ha-truong-AccSamplingDesign_files/figure-latex/fig-vitA-compare-plans-1} 
...
\midrule
0.0050 & 0.03 & AccSamplingDesign & 0.88 & 62 & 2.192\\
0.0050 & 0.03 & AcceptanceSampling & 11.58 & 62 & 2.194\\
0.0075 & 0.03 & AccSamplingDesign & 0.90 & 93 & 2.127\\
0.0075 & 0.03 & AcceptanceSampling & 18.09 & 93 & 2.127\\
0.0100 & 0.03 & AccSamplingDesign & 1.54 & 138 & 2.079\\
\addlinespace
0.0100 & 0.03 & AcceptanceSampling & 26.30 & 138 & 2.079\\
0.0125 & 0.03 & AccSamplingDesign & 1.75 & 205 & 2.041\\
0.0125 & 0.03 & AcceptanceSampling & 47.14 & 205 & 2.041\\
0.0150 & 0.03 & AccSamplingDesign & 1.54 & 309 & 2.009\\
0.0150 & 0.03 & AcceptanceSampling & 71.06 & 309 & 2.009\\
\addlinespace
0.0175 & 0.03 & AccSamplingDesign & 1.79 & 491 & 1.982\\
0.0175 & 0.03 & AcceptanceSampling & 79.24 & 491 & 1.982\\
0.0200 & 0.03 & AccSamplingDesign & 1.91 & 836 & 1.957\\
0.0200 & 0.03 & AcceptanceSampling & 99.87 & 836 & 1.957\\
\bottomrule
\end{tabular}
\end{table}
...
{\centering \includegraphics[width=1\linewidth,alt={The plot compares computation times of the AccSamplingDesign and AcceptanceSampling packages across various CRQ - PRQ gaps. AccSamplingDesign is consistently faster and shows stable performance regardless of gap size.}]{ha-truong-AccSamplingDesign_files/figure-latex/compare-pkg-plot-pdf-1} 
