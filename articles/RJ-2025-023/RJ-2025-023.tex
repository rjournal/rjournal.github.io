...
This can be achieved in \CRANpkg{theftdlc} by specifying \texttt{type\ =\ "matrix"} when calling \texttt{plot} on a \texttt{feature\_calculations} object to produce a heatmap of the time series (rows) \(\times\) feature matrix (columns) which organizes the rows and columns to help reveal interesting patterns in the data.
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{RJ-2025-023_files/figure-latex/featureMatrix-1.pdf}}
...
For example, different linkage algorithms for hierarchical clustering can be controlled by supplying the argument to \texttt{clust\_method}, which uses average agglomeration as a default, and the different rescaling methods defined earlier can be supplied to the \texttt{norm\_method} argument, which defaults to \texttt{"zScore"}.
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{RJ-2025-023_files/figure-latex/tsne-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{RJ-2025-023_files/figure-latex/featureSetComparisons-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{RJ-2025-023_files/figure-latex/topFeatureCorrelations-1.pdf}}
...
The plot shows that with regard to autocorrelation structure, we see that \texttt{eyesClosed} exhibits typically weak to moderate negative coefficient values at lag 6, while \texttt{hippocampus} and \texttt{epileptogenic} exhibit typically moderate positive coefficients.
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{RJ-2025-023_files/figure-latex/topFeatureViolins-1.pdf}}
