...
In this section, we illustrate the use of our package and its key functionalities through two examples\footnote{The example code utilizes \CRANpkg{dplyr} \citep{dplyr}, \CRANpkg{ggplot2} \citep{ggplot2manual}, and \CRANpkg{gridExtra} \citep{gridExtra}}. The package is available on GitHub\footnote{See \url{https://github.com/timginker/boiwsa}}, and via the Comprehensive R Archive Network (CRAN)\footnote{See \url{https://cran.r-project.org/package=boiwsa}}. The first example is based on the data with a strong trend-cycle and dominant intra-yearly seasonality. The second example is based on the data where the level is relatively stable, but there are two seasonal cycles - intra-yearly and intra-monthly - and a pronounced effect of two moving holidays.
...
{\centering \includegraphics[width=0.7\linewidth,]{RJ-2024-032_files/figure-latex/gasoline-1} 
...
{\centering \includegraphics[width=0.7\linewidth,]{RJ-2024-032_files/figure-latex/gasoline-sa-1} 
...
{\centering \includegraphics[width=0.7\linewidth,]{RJ-2024-032_files/figure-latex/gasoline-spec-1} 
...
{\centering \includegraphics[width=0.7\linewidth,]{RJ-2024-032_files/figure-latex/unemp-1} 
...
{\centering \includegraphics[width=0.7\linewidth,]{RJ-2024-032_files/figure-latex/unemp-sa-bad-1} 
...
{\centering \includegraphics[width=0.7\linewidth,]{RJ-2024-032_files/figure-latex/unemp-sa-fixed-1} 
...
{\centering \includegraphics[width=0.7\linewidth,]{RJ-2024-032_files/figure-latex/unemp-spec-1} 
