...
\begin{figure}[t]
  %\centering
  \begin{tabular}{cc}
    \includegraphics[width=0.48\linewidth]{fig/volatility-xicor} & \includegraphics[width=0.48\linewidth]{fig/volatility-shorth} \\
    1. xicor & 2. shorth \\
  \end{tabular}
...
\begin{figure}[t]
  %\centering
  \begin{tabular}{cc}
    \includegraphics[width=0.48\linewidth]{fig/goetze-max-n200-nosmooth} &    \includegraphics[width=0.48\linewidth]{fig/goetze-max-n200-smooth}\\
...
\item[{\parbox[t]{\textwidth}{%
  \code{estimate.tau(data, statistic, R=1000, replace=FALSE, min.m=3, }\\
  \hspace*{6.5em}\code{gamma=seq(0.2, 0.7, length.out=5), method="variance", ...)}
}}] \ \\
...
\item[{\parbox[t]{\textwidth}{%
  \code{estimate.m(data, statistic, tau, R=1000, replace=FALSE, min.m=3,}\\
  \hspace*{5.6em}\code{method="bickel", params=NULL, ...)}
}}] \ \\
...
\begin{figure}[b]
  %\centering
  \begin{tabular}{cc}
  \includegraphics[width=0.48\linewidth]{fig/pcov-fixed-m-shorth} & \includegraphics[width=0.48\linewidth]{fig/pcov-fixed-m-xicor} \\
  {a. shorth} & {b. xicor} \\
  \end{tabular}
...
\begin{figure}[t]
  \begin{tabular}{cc}
    \includegraphics[width=0.48\linewidth]{fig/pcov-databased-m-max} & \includegraphics[width=0.48\linewidth]{fig/pcov-databased-m-shorth}\\
    {a. max} & {b. shorth} \\
    \includegraphics[width=0.48\linewidth]{fig/pcov-databased-m-xicor} &     \includegraphics[width=0.48\linewidth]{fig/pcov-databased-m-mean}\\
    {c. xicor} & {d. mean}\\
  \end{tabular}
...
\begin{figure}[t]
  %\centering
  \begin{tabular}{cc}
    \includegraphics[width=0.48\linewidth]{fig/mean-comparison-pcov} &     \includegraphics[width=0.48\linewidth]{fig/mean-comparison-length} \\
