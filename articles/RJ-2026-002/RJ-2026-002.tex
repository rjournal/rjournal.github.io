...
The \CRANpkg{gasmodel} package is accessible on CRAN at \href{https://cran.r-project.org/web/packages/gasmodel/index.html}{cran.r-project.org/package=gasmodel}. Additionally, users can find the development version of the package on GitHub at \href{https://github.com/vladimirholy/gasmodel}{github.com/vladimirholy/gasmodel}, providing them with the opportunity to report any bugs or issues they encounter.
...
\begin{figure}
\includegraphics[width=0.9\linewidth]{RJ-2026-002_files/figure-latex/tv-1} \caption{The fitted logarithm of the mean. The horizontal dashed line represents the unconditional value of the logarithm of the mean.}\label{fig:tv}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.9\linewidth]{RJ-2026-002_files/figure-latex/fcst-1} \caption{The forecasted toilet paper sales for the next year. The product is assumed to be always promoted. The vertical dotted line divides the in-sample and out-of-sample periods.}\label{fig:fcst}
\end{figure}
...
#>    -0.0126389898     0.0062104317    -0.0020216686    -0.0040419594 
#>  log(mean)_beta4  log(mean)_beta5  log(mean)_beta6  log(mean)_beta7 
#>     0.0040558932     0.0186693180    -0.0017401598     0.0033140955 
#> log(mean)_alpha1   log(mean)_phi1       dispersion 
#>    -0.0009915868     0.0058394839     0.0008697134
\end{verbatim}
