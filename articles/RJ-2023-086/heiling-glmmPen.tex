...
\abstract{ % 150 words (limit 150 words)
...
%, and  also provides user-friendly functions for automated tuning parameter selection and model initialization strategies.  
% The package also provides a user interface similar to the popular \CRANpkg{lme4} R package, and can similarly fit  traditional GLMMs without penalization in low dimensions. 
