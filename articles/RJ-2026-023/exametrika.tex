...
\begin{figure}
\centering
\includegraphics[width=0.75\linewidth,height=\textheight,keepaspectratio,alt={Data analysis workflow in exametrika.}]{exametrika_files/figure/workflow_diagram.png}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{exametrika_files/figure-latex/LRAplot-1} \caption{IRP plots}\label{fig:LRAplot}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{exametrika_files/figure-latex/LRAplot2-1} \caption{RMP plots}\label{fig:LRAplot2}
\end{figure}
...
\begin{center}\includegraphics[width=0.5\linewidth]{exametrika_files/figure-latex/BNM_example-1} \end{center}
