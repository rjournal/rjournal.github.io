...
\code{ lulc\_table}, \code{ interval\_lvl}, \code{ category} \code{\_lvlGain}, \code{category\_lvlLoss},
...
\emph{\textbf{transition}} \emph{\textbf{\_lvlLoss\_m}} are \code{"Transition"} objects.
...
In the São Lourenço river basin, the interval level plot shows that LUC change
