...
\title{\pkg{nlstac}: Non-Gradient Separable Nonlinear Least Squares Fitting}
...
\address{J. A. F. Torvisco\\
Facultad de Ciencias, Universidad de Extremadura\\
Avda de Elvas s/n, 06006 Badajoz, Spain\\
ORCiD: 0000-0001-8373-3477\\
\email{jfernandck@alumnos.unex.es}}

\address{R. Ben\'itez\\
Departmento de Matemáticas para la Econom\'ia y la Empresa, Universidad de Valencia\\
