...
The other three functions, \code{huber.mean}, \code{huber.cov} and \code{huber.reg} implement data-driven robust methods for estimating the mean vector and covariance matrix \citep{KMRSZ2019} as well as the regression coefficients \citep{SZF2020}.
