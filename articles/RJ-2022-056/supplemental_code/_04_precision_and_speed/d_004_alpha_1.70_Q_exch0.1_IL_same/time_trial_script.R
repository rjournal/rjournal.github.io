...
nsest3 # tol<- 1e-05: 0.5148227 in  3 minutes
       # tol<- 1e-06: 0.5148227 in 11 minutes
...
# > time_for_truth <- end.truth - begin.truth
# > print(time_for_truth)
# Time difference of 3.02726 mins
# > print(paste0("The hcubature TRUTH integral value:" ))
...
wonty <-  
  ggplot(results[-1,]) +
    ...
    scale_y_continuous(name=NULL,
                       labels=c(#TRUTH-1e-5,
                                #TRUTH+1e-5,
                         expression(0.514*underline(7)*227),#TRUTH-1e-4, ##0.5148227
                         expression(0.514*underline(9)*227),#TRUTH+1e-4,
                         expression(underline(0.513)*8227),#TRUTH-1e-4, ##0.5148227
                         expression(underline(0.515)*8227),#TRUTH+1e-4,
                                TRUTH
                                ),
                       breaks=c(#TRUTH-1e-5,
                                #TRUTH+1e-5,
