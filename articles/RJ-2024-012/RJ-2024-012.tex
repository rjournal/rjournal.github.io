...
\title{\textbf{LUCIDus}: An R Package For Implementing Latent Unknown Clustering By Integrating Multi-omics Data (LUCID) With Phenotypic Traits}


\author{by Yinqi Zhao, Qiran Jia, Jesse A. Goodrich, and David V. Conti}
...
this article, we introduce \textbf{LUCIDus} version 3, an R package to
implement the LUCID model. We review the statistical background of the
model and introduce the workflow of \textbf{LUCIDus}, including model
...
\citep{tibshirani1996regression}. An extension of LASSO, Group LASSO, allows
...
\subsection{Model and software}\label{sec2}
...
The \textbf{LUCIDus} package includes five main functions and two auxiliary
...
In Equation \eqref{eq:eq1}, the latent clusters \(\boldsymbol{\mathbf{X}}\)
...
\paragraph{Adjusting for covariates}\label{sec3.1.3}
...
A direct call of \texttt{summary()} with the input of a model returned by
...
2001 N Soto St., Los Angeles, CA, 90032\\ United States\\ \url{yinqiz@usc.edu}\\
%
%
\textit{ORCiD: \href{https://orcid.org/0000-0003-2413-732X}{0000-0003-2413-732X}}\\%
%
}
...
Division of Biostatistics, Department of Population and Public Health
Sciences, University of Southern California\\%
2001 N Soto St., Los Angeles, CA, 90032\\ United States\\ \url{qiranjia@usc.edu}\\
%
%
\textit{ORCiD: \href{https://orcid.org/0000-0002-0790-5967}{0000-0002-0790-5967}}\\%
%
}
...
2001 N Soto St., Los Angeles, CA, 90032\\ United States\\ ORCid: 0000-0001-6615-0472\\ \url{jagoodri@usc.edu}\\
%
%
%
%
...
Division of Biostatistics, Department of Population and Public Health
Sciences, University of Southern California\\%
2001 N Soto St., Los Angeles, CA, 90032\\ United States\\ ORCid: 0000-0002-2941-7833\\ \url{dconti@usc.med.edu}\\
%
%
%
%
