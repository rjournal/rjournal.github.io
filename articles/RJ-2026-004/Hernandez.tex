...
\begin{figure}
\includegraphics[width=0.8\linewidth,height=0.32\textheight]{Hernandez_files/figure-latex/pmf-1} \caption{Probability mass function for the HYPERPO with three different values for the second parameter.}\label{fig:pmf}
\end{figure}
...
{\centering \includegraphics[width=0.5\linewidth,height=0.4\textheight,alt={}]{figures/case1_mean_true_mu=3} 
...
{\centering \includegraphics[width=0.5\linewidth,height=0.4\textheight,alt={}]{figures/case1_mean_true_mu=7} 
...
{\centering \includegraphics[width=0.5\linewidth,height=0.4\textheight,alt={}]{figures/case1_mse_true_mu=3} 
...
{\centering \includegraphics[width=0.5\linewidth,height=0.4\textheight,alt={}]{figures/case1_mse_true_mu=7} 
...
{\centering \includegraphics[width=0.6\linewidth,height=0.3\textheight,alt={}]{figures/case2_mean} 
...
{\centering \includegraphics[width=0.6\linewidth,height=0.3\textheight,alt={}]{figures/case2_mse} 
...
{\centering \includegraphics[width=0.6\linewidth,height=0.2\textheight,alt={}]{figures/hist_number_bids} 
...
{\centering \includegraphics[width=0.6\linewidth,height=0.18\textheight,alt={}]{figures/worm_rqr_plot} 
