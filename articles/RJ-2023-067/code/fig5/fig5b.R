## This file generates Figure 5b of our manuscript. ##
...
title <- "Dispersion"
dist_sample <- function(n, l) {
    mvrnorm(n, mu = rep(0, 2), Sigma = diag(2) + l)
}
param0 <- 0
param <- seq(0.05, 3.20, 0.35)
...
saveRDS(pplt, file = "data/fig5b.rds")
