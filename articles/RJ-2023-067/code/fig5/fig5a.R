## This file generates Figure 5a of our manuscript. ##
...
dist_sample <- function(n, p) {
    mvrnorm(n, mu = rep(p, 2), Sigma = diag(2))
}
param0 <- 0
param <- c(seq(-1.21, -0.01, 0.3), seq(0.01, 1.21, 0.3))
xlab <- expression(mu)
...
saveRDS(pplt, file = "data/fig5a.rds")
