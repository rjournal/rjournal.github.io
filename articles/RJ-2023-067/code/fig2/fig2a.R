## This file generates Figure 2a of our manuscript. ##
...
times_df <- data.frame(x = nvals, y_rt = times_rt/10^6, y_bf = times_bf/10^6)
...
saveRDS(pplt, file = "data/fig2a.rds")
