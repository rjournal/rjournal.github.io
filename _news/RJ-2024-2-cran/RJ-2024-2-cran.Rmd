...
subtitle: 2024-07-01 to 2024-09-30
date: '2024-06-01'
draft: no
author:
- name: Kurt Hornik
...
svn diff -r{2024-07-01}:{2024-09-30}
```
...
<https://ror.org/>) in a package's `DESCRIPTION` file in case there are organizations among
...
## generate via cran_views(new = "DynamicVisualizations")
