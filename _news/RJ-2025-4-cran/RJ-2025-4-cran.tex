...
In the past 3 months, 590~new packages were
added to the CRAN package repository. 158~packages
were unarchived, 594~were archived and
0~had to be removed. The following shows the
growth of the number of active packages in the CRAN package repository:

\begin{center}\includegraphics[width=1\linewidth,alt={CRAN growth: Number of CRAN packages over time in levels (left) and in logs (right).}]{RJ-2025-4-cran_files/figure-latex/cran_growth-1} \end{center}

\noindent On 2025-12-31, the number of active packages was around~22969.

\section{CRAN package submissions}\label{cran-package-submissions}

From October 2025 to December 2025
CRAN received 7066~package submissions.
For these, 11187~actions took place of which
8337~(75\%) were auto processed actions and
2850~(25\%) manual actions.
...
Overall, these task views cover 5003~CRAN packages,
