...
[1](#fig:map){reference-type="ref" reference="fig:map"}). Of those who
registered, 452 attended at least some sessions live and 431 watched
some sessions via the replay feature in Crowdcast. The main conference
was held over two days and included 4 keynote addresses, 16 regular
talks, 11 lightning talks, and one panel discussion. The schedule
included three BoF time slots, each with 4-5 different topics.

![Location of those who registered for the 2020 R/Medicine
conference](Figure.png){#fig:map width="0.7\\linewidth"}
